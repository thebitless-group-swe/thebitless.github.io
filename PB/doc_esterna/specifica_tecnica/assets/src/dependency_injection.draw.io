<mxGraphModel dx="2289" dy="913" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
  <root>
    ...
    <mxCell id="frameRoutes" parent="1" style="rounded=1;whiteSpace=wrap;html=1;dashed=1;dashPattern=8 8;fillColor=#F8F8F8;strokeColor=#666666;verticalAlign=top;align=left;spacingLeft=12;spacingTop=6;fontSize=12;fontColor=#666666;" value="&lt;b&gt;app/api/routes/&lt;/b&gt; — adattatori primari" vertex="1">
    ...
    <mxCell id="frameProd" parent="1" style="rounded=1;whiteSpace=wrap;html=1;dashed=1;dashPattern=8 8;fillColor=#F8F8F8;strokeColor=#666666;verticalAlign=top;align=left;spacingLeft=12;spacingTop=6;fontSize=12;fontColor=#666666;" value="&lt;b&gt;app/infrastructure/adapters/&lt;/b&gt; — adattatori secondari" vertex="1">
      <mxGeometry height="170" width="580" x="170" y="1010" as="geometry" />
    </mxCell>
    <mxCell id="frameTest" parent="1" style="rounded=1;whiteSpace=wrap;html=1;dashed=1;dashPattern=8 8;fillColor=#FAFAFA;strokeColor=#666666;verticalAlign=top;align=left;spacingLeft=12;spacingTop=6;fontSize=12;fontColor=#666666;" value="&lt;b&gt;tests/conftest.py&lt;/b&gt; — i doppi" vertex="1">
      <mxGeometry height="170" width="590" x="810" y="1010" as="geometry" />
    </mxCell>
    <mxCell id="routeSix" parent="1" style="swimlane;childLayout=stackLayout;horizontal=1;startSize=62;horizontalStack=0;resizeParent=1;resizeParentMax=0;html=1;verticalAlign=middle;align=center;whiteSpace=wrap;collapsible=0;strokeColor=#666666;fillColor=#E6E6E6;fontSize=12;" value="«adattatore primario»&lt;br&gt;&lt;b&gt;le sei rotte a una porta&lt;/b&gt;&lt;br&gt;&lt;i&gt;summarize · translate · rewrite · grammar · critique · generate&lt;/i&gt;" vertex="1">
    ...
    <mxCell id="routeLink" parent="1" style="swimlane;childLayout=stackLayout;horizontal=1;startSize=62;horizontalStack=0;resizeParent=1;resizeParentMax=0;html=1;verticalAlign=middle;align=center;whiteSpace=wrap;collapsible=0;strokeColor=#666666;fillColor=#E6E6E6;fontSize=12;" value="«adattatore primario»&lt;br&gt;&lt;b&gt;la rotta a due porte&lt;/b&gt;&lt;br&gt;&lt;i&gt;app/api/routes/generate_link.py&lt;/i&gt;" vertex="1">
    ...
    <mxCell id="resolver" parent="1" style="swimlane;childLayout=stackLayout;horizontal=1;startSize=50;horizontalStack=0;resizeParent=1;resizeParentMax=0;html=1;verticalAlign=middle;align=center;whiteSpace=wrap;collapsible=0;strokeColor=#666666;fillColor=#DBDBDB;fontSize=12;" value="«meccanismo FastAPI»&lt;br&gt;&lt;b&gt;Risoluzione delle dipendenze&lt;/b&gt;" vertex="1">
    ...
    <mxCell id="deps" parent="1" style="swimlane;childLayout=stackLayout;horizontal=1;startSize=62;horizontalStack=0;resizeParent=1;resizeParentMax=0;html=1;verticalAlign=middle;align=center;whiteSpace=wrap;collapsible=0;strokeColor=#666666;fillColor=#E0E0E0;fontSize=13;" value="«composition root»&lt;br&gt;&lt;b&gt;app/dependencies.py&lt;/b&gt;&lt;br&gt;&lt;i&gt;l&#39;unico modulo che nomina gli adattatori concreti&lt;/i&gt;" vertex="1">
    ...
    <mxCell id="dp_3" parent="deps" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=6;spacingRight=6;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=1;fontSize=10;fontColor=#4B4B4B;" value="&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;⟶ LiteLLMClient(get_settings())&amp;nbsp;&amp;nbsp;|&amp;nbsp;&amp;nbsp;503 se manca LITELLM_API_KEY" vertex="1">
    ...
    <mxCell id="dp_5" parent="deps" style="text;strokeColor=none;fillColor=none;align=left;verticalAlign=middle;spacingLeft=6;spacingRight=6;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;html=1;fontSize=10;fontColor=#4B4B4B;" value="&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;⟶ TavilyExtractor(api_key)&amp;nbsp;&amp;nbsp;|&amp;nbsp;&amp;nbsp;503 se manca TAVILY_API_KEY" vertex="1">
    ...
    <mxCell id="useCase" parent="1" style="swimlane;childLayout=stackLayout;horizontal=1;startSize=62;horizontalStack=0;resizeParent=1;resizeParentMax=0;html=1;verticalAlign=middle;align=center;whiteSpace=wrap;collapsible=0;strokeColor=#5A5A5A;fillColor=#F6F6F6;fontSize=12;" value="«use case»&lt;br&gt;&lt;b&gt;core/services/&lt;/b&gt;&lt;br&gt;&lt;i&gt;sette funzioni, una per file&lt;/i&gt;" vertex="1">
    ...
    <mxCell id="litellm" parent="1" style="rounded=0;whiteSpace=wrap;html=1;fillColor=#EBEBEB;strokeColor=#666666;align=center;verticalAlign=middle;fontSize=11;" value="&lt;b&gt;LiteLLMClient&lt;/b&gt;&lt;br&gt;&lt;i&gt;litellm_client.py&lt;/i&gt;&lt;br&gt;httpx · SSE del provider" vertex="1">
      <mxGeometry height="100" width="260" x="200" y="1060" as="geometry" />
    </mxCell>
    <mxCell id="tavily" parent="1" style="rounded=0;whiteSpace=wrap;html=1;fillColor=#EBEBEB;strokeColor=#666666;align=center;verticalAlign=middle;fontSize=11;" value="&lt;b&gt;TavilyExtractor&lt;/b&gt;&lt;br&gt;&lt;i&gt;tavily_extractor.py&lt;/i&gt;&lt;br&gt;API Tavily · troncamento" vertex="1">
      <mxGeometry height="100" width="250" x="480" y="1060" as="geometry" />
    </mxCell>
    <mxCell id="dummyLLM" parent="1" style="rounded=0;whiteSpace=wrap;html=1;fillColor=#F2F2F2;strokeColor=#666666;align=center;verticalAlign=middle;fontSize=11;" value="&lt;b&gt;DummyLLMClient&lt;/b&gt;&lt;br&gt;chunk fissi, nessun I/O&lt;br&gt;&lt;i&gt;registra received_messages&lt;/i&gt;" vertex="1">
      <mxGeometry height="100" width="260" x="840" y="1060" as="geometry" />
    </mxCell>
    <mxCell id="dummyCE" parent="1" style="rounded=0;whiteSpace=wrap;html=1;fillColor=#F2F2F2;strokeColor=#666666;align=center;verticalAlign=middle;fontSize=11;" value="&lt;b&gt;DummyContentExtractor&lt;/b&gt;&lt;br&gt;&lt;b&gt;FailingContentExtractor&lt;/b&gt;&lt;br&gt;&lt;i&gt;contenuto statico / errore simulato&lt;/i&gt;" vertex="1">
    ...
    <mxCell id="e3" edge="1" parent="1" source="resolver" style="endArrow=open;endSize=12;dashed=1;html=1;edgeStyle=orthogonalEdgeStyle;rounded=0;strokeColor=#4A4A4A;fontColor=#4A4A4A;exitX=0;exitY=0.5;exitDx=0;exitDy=0;entryX=0.05;entryY=1;entryDx=0;entryDy=0;fontSize=10;" target="routeSix" value="&lt;b&gt;inietta l&#39;istanza&lt;/b&gt;&lt;br&gt;tipizzata con la porta">
      <mxGeometry relative="1" as="geometry">
        <Array as="points">
          <mxPoint x="222" y="377" />
        </Array>
    ...
    <mxCell id="e12" edge="1" parent="1" source="dummyLLM" style="endArrow=block;endFill=0;endSize=10;dashed=1;html=1;edgeStyle=orthogonalEdgeStyle;rounded=0;strokeColor=#666666;exitX=0.5;exitY=0;exitDx=0;exitDy=0;entryX=0.85;entryY=1;entryDx=0;entryDy=0;" target="portLLM">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
    <mxCell id="e13" edge="1" parent="1" source="dummyCE" style="endArrow=block;endFill=0;endSize=10;dashed=1;html=1;edgeStyle=orthogonalEdgeStyle;rounded=0;strokeColor=#666666;exitX=0.5;exitY=0;exitDx=0;exitDy=0;entryX=0.85;entryY=1;entryDx=0;entryDy=0;" target="portCE">
      <mxGeometry relative="1" as="geometry" />
    </mxCell>
    <mxCell id="e14" edge="1" parent="1" source="frameTest" style="endArrow=open;endSize=12;dashed=1;html=1;edgeStyle=orthogonalEdgeStyle;rounded=0;strokeColor=#666666;fontColor=#666666;strokeWidth=2;exitX=1;exitY=0;exitDx=0;exitDy=0;entryX=0.9;entryY=0;entryDx=0;entryDy=0;fontSize=10;verticalAlign=bottom;" target="resolver" value="&lt;b&gt;app.dependency_overrides[get_llm_client] = lambda: DummyLLMClient()&lt;/b&gt;&lt;br&gt;il provider non viene mai invocato">
      <mxGeometry relative="1" as="geometry">
        <Array as="points">
