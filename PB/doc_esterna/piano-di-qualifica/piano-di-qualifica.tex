...
\begin{longtable}{|c|c|c|c|c|p{3.5cm}|}
    ...
    \hline
    \endhead
    1.6.0 & 2026-08-20 & A. Marini & S. Zecchinato & - & Sistema$_G$ errori ortografici e di battitura \\
    \hline
...
Analizzando il grafico in Figura \ref{fig:pv-ev} tra lo Sprint$_G$ 8 e lo Sprint$_G$ 12, si osserva la fase di completamento del progetto, in cui sia il \textit{Planned Value} che l'\textit{Earned Value} convergono progressivamente verso il valore cumulato finale di circa 12.500,00 €. 
