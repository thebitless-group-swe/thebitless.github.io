...
\begin{itemize}
    \item Dalla fase di PB il numero di metriche considerate aumenta (da 11 a 35) e questo riscala le percentuali mostrate in \textit{MPC-PMS}. Questo, quindi, vale dallo sprint 8 in poi.
...
\end{itemize}
Ciò detto, possiamo notare che durante gli sprint successivi, le percentuali di metriche soddisfatte aumentano fino ad arrivare al 100\% degli ultimi due sprint.
