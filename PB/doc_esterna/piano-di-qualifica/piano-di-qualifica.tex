...
La rilevazione si ferma all'undicesimo sprint$_G$ perché è in esso che si è concluso lo sviluppo$_G$ dell'MVP$_G$; l'ultima modifica al codice sorgente risale dentro la finestra dell'undicesimo sprint$_G$. Lo sprint$_G$ successivo non ha comportato alcuna modifica al prodotto e i valori rilevati sarebbero identici a quelli dello sprint$_G$ 11, senza aggiungere alcuna informazione sull'andamento della qualità.
...
\end{itemize}
Come si osserva in Figura \ref{fig:mpd-mod}, la serie è una retta collocata fra le due soglie.d
\begin{figure}[H]
