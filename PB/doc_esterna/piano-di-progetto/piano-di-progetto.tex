...
Al netto della posta negativa dell'Analista\textsubscript{G}, la distribuzione concentra il 67,6\% delle ore residue sui ruoli Programmatore\textsubscript{G} e Verificatore\textsubscript{G}, di cui il solo Verificatore\textsubscript{G} rappresenta il 45,1\%. La ripartizione è coerente con la fase in corso: completata la codifica\textsubscript{G} dell'MVP\textsubscript{G} nello Sprint\textsubscript{G} \#10, il periodo conclusivo è dedicato alla verifica\textsubscript{G} dei documenti, al collaudo\textsubscript{G} del prodotto e al completamento della documentazione. Il monte ore complessivo del progetto resta di 623 ore e il budget totale di 12.335,00 €.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|c|c|c|c|c|c|c|}
        ...
        \hline
        \rowcolor[HTML]{EFEFEF}
        \textbf{Costo totale (in €)} & \textbf{300,00} & \textbf{20,00} & \textbf{-225,00} & \textbf{525,00} & \textbf{240,00} & \textbf{480,00} & \textbf{1.340,00} \\
        \hline
    \end{tabularx}
    \caption{Preventivo a finire al termine dello Sprint \#10}
\end{table}
