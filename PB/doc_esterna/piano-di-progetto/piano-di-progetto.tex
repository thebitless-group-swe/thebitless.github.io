...
\begin{itemize}
    ...
    \item \textbf{Descrizione:} Il successo del progetto \textit{Second Brain} dipende anche dal confronto con la Proponente per validare scelte progettuali e chiarire dettagli tecnici (es. limiti delle API\textsubscript{G} o criteri di valutazione degli LLM\textsubscript{G}). Poiché i referenti aziendali hanno impegni professionali prioritari, è possibile che si verifichino variazioni nella loro disponibilità o lievi ritardi nelle risposte. Tuttavia, essendo i requisiti di base già ben delineati nel capitolato, un rallentamento nei feedback non blocca l'avanzamento, portando al più il gruppo ad assumere decisioni temporanee basate su interpretazioni autonome.

    \item \textbf{Strategie di rilevamento:} Il Responsabile monitora i tempi di risposta alle email e la facilità nel fissare i periodici incontri di allineamento. Il superamento delle tempistiche di comunicazione standard definite nelle Norme di Progetto\textsubscript{G} costituisce il principale segnale di allerta.

    \item \textbf{Contromisure:} Per ottimizzare i tempi, il gruppo si impegna a raggruppare i dubbi in liste strutturate, inviandole con congruo anticipo. In caso di prolungata assenza di supporto, il team documenta formalmente nei verbali le decisioni assunte in autonomia e le relative motivazioni. Grazie all'approccio Agile, la pianificazione flessibile consente di disaccoppiare l'avanzamento dalla validazione aziendale, spostando tempestivamente l'effort su task\textsubscript{G} indipendenti dal riscontro esterno senza compromettere le scadenze didattiche.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|L|c|c|}
        ...
        \hline
        \textbf{RP-2} & Mancanza di supporto della Proponente & Media & Bassa \\
        \hline
    \end{tabularx}
...
Alla luce dell'analisi del capitolato \textit{Second Brain}, dei rischi individuati e delle attività previste per lo sviluppo del prodotto, il gruppo ha elaborato una stima delle ore necessarie alla realizzazione del progetto.
La stima considera le attività associate ai diversi ruoli previsti dal progetto: Responsabile\textsubscript{G}, Amministratore\textsubscript{G}, Analista\textsubscript{G}, Progettista\textsubscript{G}, Programmatore\textsubscript{G} e Verificatore\textsubscript{G}. 

In chiusura del progetto, il monte ore complessivo si attesta a \textbf{628 ore}. La distribuzione fra i ruoli\textsubscript{G} è stata allineata all'impiego effettivamente rilevato lungo il progetto per far combaciare esattamente le ore preventivate con quelle consuntivate. Il ruolo Analista\textsubscript{G} chiude a 71 ore, recependo le ore eccedenti maturate sulla revisione dei requisiti\textsubscript{G} non funzionali, e l'Amministratore\textsubscript{G} a 64; per contro il Programmatore\textsubscript{G} scende a 152 ore, il Progettista\textsubscript{G} a 135, il Verificatore\textsubscript{G} a 159 e il Responsabile\textsubscript{G} a 47. La valorizzazione totale effettiva del progetto è pari a \textbf{12.505,00 €}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        \hline
        Responsabile di progetto & 47 & 30,00 & 1.410,00 \\ \hline
        Amministratore & 64 & 20,00 & 1.280,00 \\ \hline
        Analista & 71 & 25,00 & 1.775,00 \\ \hline
        Progettista & 135 & 25,00 & 3.375,00 \\ \hline
        Programmatore & 152 & 15,00 & 2.280,00 \\ \hline
        Verificatore & 159 & 15,00 & 2.385,00 \\ \hline
        \rowcolor[HTML]{EFEFEF}
...
Di seguito è riportato il preventivo ``a finire''. Al termine dello Sprint\textsubscript{G} \#12, ultimo periodo del progetto, risultano consuntivate 628 ore delle 628 preventivate finali: \textbf{il monte ore è integralmente impiegato, il prospetto si azzera in ogni sua voce e non residuano né ore né costi}.
...
\subsubsection{Obiettivi}
Lo Sprint\textsubscript{G} \#12 è il periodo conclusivo del progetto e mantiene la cadenza settimanale adottata a partire dallo Sprint\textsubscript{G} \#10. La riunione di apertura del 2026-08-18 ha constatato che tutte le attività di produzione sono terminate: l'MVP\textsubscript{G} è stato dichiarato completato e rilasciato in versione 2.0.0 e la documentazione destinata alla Product Baseline\textsubscript{G} è redatta e verificata. Il periodo non prevede pertanto alcuna attività produttiva ed è dedicato alla \textbf{comunicazione con la Proponente\textsubscript{G} e alla preparazione delle presentazioni finali}.

A differenza di tutti i periodi precedenti, \textbf{in apertura di sprint\textsubscript{G} non sono stati definiti task rigidi}. La scelta discende da due condizioni di incertezza esterne al gruppo, entrambe registrate nel verbale\textsubscript{G} della riunione di apertura:
\begin{itemize}
    \item il gruppo era \textbf{in attesa del riscontro della Proponente\textsubscript{G} sull'MVP\textsubscript{G}}, trasmesso in modalità asincrona a causa del periodo di ferie estive del referente aziendale, secondo quanto descritto dal rischio\textsubscript{G} RP-2. Fino alla ricezione del riscontro non era possibile stabilire se e quali modifiche al prodotto o alla documentazione si sarebbero rese necessarie: l'eventualità di dover recepire richieste della Proponente\textsubscript{G} è stata tenuta esplicitamente aperta;

    \item la \textbf{richiesta di incontro al prof. Riccardo Cardin} per la prima parte della presentazione della Product Baseline\textsubscript{G} non aveva ancora una data confermata e, con essa, restava indeterminato il termine entro cui predisporre il materiale espositivo.
\end{itemize}

Il gruppo ha quindi preventivato\textsubscript{G} i ruoli\textsubscript{G} e il relativo monte ore senza vincolarli a un elenco chiuso di attività, dimensionando il preventivo\textsubscript{G} in modo da garantire la copertura delle due sole attività di coordinamento certe --- la gestione della comunicazione con la Proponente\textsubscript{G} e la richiesta al prof. Riccardo Cardin --- e da lasciare capacità residua sul ruolo Verificatore\textsubscript{G} per gli eventuali interventi conseguenti al riscontro. Le decisioni operative sono state assunte in corso di periodo mediante \textbf{riunioni interne di allineamento}, convocate man mano che le informazioni attese diventavano disponibili: in questo periodo la comunicazione continua e flessibile sostituisce la pianificazione\textsubscript{G} di dettaglio.

Gli obiettivi sono pertanto formulati in termini di risultati attesi anziché di attività:
\begin{itemize}
    \item ricevere il riscontro della Proponente\textsubscript{G} sull'MVP\textsubscript{G} e recepirne le eventuali richieste;

    \item richiedere al prof. Riccardo Cardin l'incontro per la prima parte della presentazione della Product Baseline\textsubscript{G} e redigere la relativa lettera di presentazione;

    \item predisporre le diapositive sull'architettura\textsubscript{G} del software e preparare l'esposizione;

    \item svolgere gli ultimi controlli formali e contenutistici sugli artefatti\textsubscript{G} destinati alla Product Baseline\textsubscript{G};

    \item redigere il verbale\textsubscript{G} interno della riunione del periodo, secondo quanto previsto dalle \textit{Norme di Progetto}.
\end{itemize}

La composizione dei ruoli\textsubscript{G} recepisce quanto stabilito nella riunione di apertura: \textbf{risultano attivi quattro ruoli\textsubscript{G}}, ossia Responsabile\textsubscript{G}, Amministratore\textsubscript{G}, Progettista\textsubscript{G} e Verificatore\textsubscript{G}. E. De Piccoli ricopre il doppio ruolo\textsubscript{G} di Responsabile\textsubscript{G} e Progettista\textsubscript{G}, S. Vendramin e S. Zecchinato quello di Progettista\textsubscript{G} e A. Marini quello di Amministratore\textsubscript{G}, mentre L. Battistella, D. Facco e A. Menegaldo operano come Verificatori\textsubscript{G}. Analista\textsubscript{G} e Programmatore\textsubscript{G} restano a zero ore, non essendo previste attività di analisi\textsubscript{G} o di codifica\textsubscript{G}.

Il periodo lavora sulle dotazioni risultanti dalla \textbf{ricalibrazione deliberata alla chiusura dello Sprint\textsubscript{G} \#11}, che ha chiuso a zero le voci di Analista\textsubscript{G} e Programmatore\textsubscript{G} e ha reso disponibili le ore necessarie alla pubblicazione dei documenti della Product Baseline\textsubscript{G}.
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.05) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (9,8\%)}};

% Amministratore
\fill[lineGray] (2.69,1.74) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.69,1.74) -- (3.90,1.74) -- (4.15,1.74);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.74) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}5 ore (12,2\%)}};

% Verificatore
\fill[lineGray] (-1.84,2.62) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.84,2.62) -- (-3.90,2.62) -- (-4.15,2.62);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.62) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}8 ore (19,5\%)}};

% Analista
\fill[lineGray] (-0.24,-3.19) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.24,-3.19) -- (-3.90,-3.19) -- (-4.15,-3.19);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.19) {\bfseries Analista\\[1pt]{\small\color{lineGray}24 ore (58,5\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.81) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}7 ore (15,9\%)}};

% Amministratore
\fill[lineGray] (3.19,0.23) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.19,0.23) -- (3.90,0.23) -- (4.15,0.23);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.23) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}7 ore (15,9\%)}};

% Verificatore
\fill[lineGray] (-2.42,2.10) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.42,2.10) -- (-3.90,2.10) -- (-4.15,2.10);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.10) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}12 ore (27,3\%)}};

% Analista
\fill[lineGray] (-0.46,-3.17) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.46,-3.17) -- (-3.90,-3.17) -- (-4.15,-3.17);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.17) {\bfseries Analista\\[1pt]{\small\color{lineGray}18 ore (40,9\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.07) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (9,1\%)}};

% Amministratore
\fill[lineGray] (2.81,1.53) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.81,1.53) -- (3.90,1.53) -- (4.15,1.53);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.53) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}7 ore (15,9\%)}};

% Analista
\fill[lineGray] (2.42,-2.10) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.42,-2.10) -- (3.90,-2.10) -- (4.15,-2.10);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-2.10) {\bfseries Analista\\[1pt]{\small\color{lineGray}10 ore (22,7\%)}};

% Verificatore
\fill[lineGray] (-2.56,1.92) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.56,1.92) -- (-3.90,1.92) -- (-4.15,1.92);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,1.92) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}13 ore (29,5\%)}};

% Progettista
\fill[lineGray] (-1.73,-2.69) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.73,-2.69) -- (-3.90,-2.69) -- (-4.15,-2.69);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-2.69) {\bfseries Progettista\\[1pt]{\small\color{lineGray}10 ore (22,7\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.98) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}6 ore (12,0\%)}};

% Amministratore
\fill[lineGray] (3.14,0.60) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.14,0.60) -- (3.90,0.60) -- (4.15,0.60);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.60) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}10 ore (20,0\%)}};

% Analista
\fill[lineGray] (2.59,-1.88) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.59,-1.88) -- (3.90,-1.88) -- (4.15,-1.88);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-1.88) {\bfseries Analista\\[1pt]{\small\color{lineGray}3 ore (6,0\%)}};

% Verificatore
\fill[lineGray] (-1.54,2.80) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.54,2.80) -- (-3.90,2.80) -- (-4.15,2.80);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.80) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}8 ore (16,0\%)}};

% Programmatore
\fill[lineGray] (-3.19,0.20) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-3.19,0.20) -- (-3.90,0.20) -- (-4.15,0.20);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,0.20) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}8 ore (16,0\%)}};

% Progettista
\fill[lineGray] (-0.60,-3.14) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.60,-3.14) -- (-3.90,-3.14) -- (-4.15,-3.14);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.14) {\bfseries Progettista\\[1pt]{\small\color{lineGray}15 ore (30,0\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.18) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}2 ore (3,2\%)}};

% Amministratore
\fill[lineGray] (1.80,2.64) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.80,2.64) -- (3.90,2.13) -- (4.15,2.13);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.13) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}8 ore (12,7\%)}};

% Progettista
\fill[lineGray] (3.08,0.87) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.08,0.87) -- (3.90,0.87) -- (4.15,0.87);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.87) {\bfseries Progettista\\[1pt]{\small\color{lineGray}6 ore (9,5\%)}};

% Verificatore
\fill[lineGray] (-1.53,2.81) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.53,2.81) -- (-3.90,2.81) -- (-4.15,2.81);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.81) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}10 ore (15,9\%)}};

% Programmatore
\fill[lineGray] (-0.94,-3.06) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.94,-3.06) -- (-3.90,-3.06) -- (-4.15,-3.06);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.06) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}37 ore (58,7\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.16) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}3 ore (5,1\%)}};

% Amministratore
\fill[lineGray] (2.29,2.23) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.29,2.23) -- (3.90,2.11) -- (4.15,2.11);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.11) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}9 ore (15,3\%)}};

% Progettista
\fill[lineGray] (3.17,-0.42) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.17,-0.42) -- (3.90,-0.42) -- (4.15,-0.42);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-0.42) {\bfseries Progettista\\[1pt]{\small\color{lineGray}8 ore (13,6\%)}};

% Verificatore
\fill[lineGray] (-2.29,2.23) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.29,2.23) -- (-3.90,2.23) -- (-4.15,2.23);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.23) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}15 ore (25,4\%)}};

% Programmatore
\fill[lineGray] (-0.84,-3.09) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.84,-3.09) -- (-3.90,-3.09) -- (-4.15,-3.09);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.09) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}24 ore (40,7\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.22) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}3 ore (37,5\%)}};

% Amministratore
\fill[lineGray] (0.00,-3.20) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.00,-3.20) -- (3.90,-3.20) -- (4.15,-3.20);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-3.20) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}2 ore (25,0\%)}};

% Verificatore
\fill[lineGray] (-2.26,2.26) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.26,2.26) -- (-3.90,2.26) -- (-4.15,2.26);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.26) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}2 ore (25,0\%)}};

% Progettista
\fill[lineGray] (-2.96,-1.22) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.96,-1.22) -- (-3.90,-1.22) -- (-4.15,-1.22);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-1.22) {\bfseries Progettista\\[1pt]{\small\color{lineGray}1 ora (12,5\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.16) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}3 ore (4,8\%)}};

% Amministratore
\fill[lineGray] (1.39,2.88) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.39,2.88) -- (3.90,2.11) -- (4.15,2.11);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.11) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}3 ore (4,8\%)}};

% Analista
\fill[lineGray] (3.18,0.40) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.18,0.40) -- (3.90,0.40) -- (4.15,0.40);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.40) {\bfseries Analista\\[1pt]{\small\color{lineGray}17 ore (27,0\%)}};

% Verificatore
\fill[lineGray] (-2.29,2.23) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.29,2.23) -- (-3.90,2.23) -- (-4.15,2.23);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.23) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}16 ore (25,4\%)}};

% Progettista
\fill[lineGray] (-1.09,-3.01) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.09,-3.01) -- (-3.90,-3.01) -- (-4.15,-3.01);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.01) {\bfseries Progettista\\[1pt]{\small\color{lineGray}24 ore (38,1\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.18) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}3 ore (3,8\%)}};

% Amministratore
\fill[lineGray] (1.25,2.94) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.25,2.94) -- (3.90,2.13) -- (4.15,2.13);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.13) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}4 ore (5,1\%)}};

% Progettista
\fill[lineGray] (3.16,0.51) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.16,0.51) -- (3.90,0.51) -- (4.15,0.51);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.51) {\bfseries Progettista\\[1pt]{\small\color{lineGray}21 ore (26,9\%)}};

% Verificatore
\fill[lineGray] (-2.48,2.02) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.48,2.02) -- (-3.90,2.02) -- (-4.15,2.02);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.02) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}22 ore (28,2\%)}};

% Programmatore
\fill[lineGray] (-0.77,-3.11) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.77,-3.11) -- (-3.90,-3.11) -- (-4.15,-3.11);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.11) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}28 ore (35,9\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.16) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (4,9\%)}};

% Amministratore
\fill[lineGray] (1.44,2.86) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.44,2.86) -- (3.90,2.11) -- (4.15,2.11);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.11) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}4 ore (4,9\%)}};

% Progettista
\fill[lineGray] (3.13,0.68) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.13,0.68) -- (3.90,0.68) -- (4.15,0.68);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.68) {\bfseries Progettista\\[1pt]{\small\color{lineGray}19 ore (23,5\%)}};

% Verificatore
\fill[lineGray] (-2.33,2.20) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.33,2.20) -- (-3.90,2.20) -- (-4.15,2.20);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.20) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}21 ore (25,9\%)}};

% Programmatore
\fill[lineGray] (-0.74,-3.11) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.74,-3.11) -- (-3.90,-3.11) -- (-4.15,-3.11);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.11) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}33 ore (40,7\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.07) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}5 ore (8,9\%)}};

% Amministratore
\fill[lineGray] (2.00,2.50) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.00,2.50) -- (3.90,2.02) -- (4.15,2.02);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.02) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}2 ore (3,6\%)}};

% Progettista
\fill[lineGray] (3.20,0.00) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.20,0.00) -- (3.90,0.00) -- (4.15,0.00);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.00) {\bfseries Progettista\\[1pt]{\small\color{lineGray}14 ore (25,0\%)}};

% Programmatore
\fill[lineGray] (0.54,-3.15) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.54,-3.15) -- (3.90,-3.15) -- (4.15,-3.15);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-3.15) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}11 ore (19,6\%)}};

% Verificatore
\fill[lineGray] (-3.12,0.71) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-3.12,0.71) -- (-3.90,0.71) -- (-4.15,0.71);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,0.71) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}24 ore (42,9\%)}};
...
\subsection{Sprint \#12: da 2026-08-18 a 2026-08-24}
Di seguito è riportata la distribuzione delle ore preventivate per ciascun membro del team, secondo la rotazione dei ruoli\textsubscript{G} definita nella riunione di apertura dello sprint\textsubscript{G} del 2026-08-18:
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.53) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (20,0\%)}};

% Amministratore
\fill[lineGray] (3.10,-0.79) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.10,-0.79) -- (3.90,-0.79) -- (4.15,-0.79);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-0.79) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}3 ore (15,0\%)}};

% Progettista
\fill[lineGray] (0.53,-3.16) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.53,-3.16) -- (3.90,-3.16) -- (4.15,-3.16);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-3.16) {\bfseries Progettista\\[1pt]{\small\color{lineGray}5 ore (25,0\%)}};

% Verificatore
\fill[lineGray] (-3.10,0.79) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-3.10,0.79) -- (-3.90,0.79) -- (-4.15,0.79);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,0.79) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}8 ore (40,0\%)}};
...
Di seguito è riportato il preventivo economico del dodicesimo sprint\textsubscript{G}:
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.85) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}6 ore (15,0\%)}};

% Amministratore
\fill[lineGray] (3.11,0.75) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.11,0.75) -- (3.90,0.75) -- (4.15,0.75);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.75) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}5 ore (12,5\%)}};

% Verificatore
\fill[lineGray] (-1.88,2.59) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.88,2.59) -- (-3.90,2.59) -- (-4.15,2.59);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.59) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}8 ore (20,0\%)}};

% Analista
\fill[lineGray] (-0.75,-3.11) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.75,-3.11) -- (-3.90,-3.11) -- (-4.15,-3.11);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.11) {\bfseries Analista\\[1pt]{\small\color{lineGray}21 ore (52,5\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.02) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}5 ore (10,9\%)}};

% Amministratore
\fill[lineGray] (2.94,1.27) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.94,1.27) -- (3.90,1.27) -- (4.15,1.27);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.27) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}7 ore (15,2\%)}};

% Analista
\fill[lineGray] (0.86,-3.08) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.86,-3.08) -- (3.90,-3.08) -- (4.15,-3.08);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-3.08) {\bfseries Analista\\[1pt]{\small\color{lineGray}18 ore (39,1\%)}};

% Verificatore
\fill[lineGray] (-2.84,1.47) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.84,1.47) -- (-3.90,1.47) -- (-4.15,1.47);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,1.47) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}16 ore (34,8\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.10) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (8,0\%)}};

% Amministratore
\fill[lineGray] (2.59,1.88) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.59,1.88) -- (3.90,1.88) -- (4.15,1.88);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.88) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}7 ore (14,0\%)}};

% Analista
\fill[lineGray] (2.59,-1.88) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.59,-1.88) -- (3.90,-1.88) -- (4.15,-1.88);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-1.88) {\bfseries Analista\\[1pt]{\small\color{lineGray}13 ore (26,0\%)}};

% Verificatore
\fill[lineGray] (-2.33,2.19) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.33,2.19) -- (-3.90,2.19) -- (-4.15,2.19);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.19) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}13 ore (26,0\%)}};

% Progettista
\fill[lineGray] (-2.04,-2.47) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.04,-2.47) -- (-3.90,-2.47) -- (-4.15,-2.47);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-2.47) {\bfseries Progettista\\[1pt]{\small\color{lineGray}13 ore (26,0\%)}};
...
\fill[lineGray] (0.74,3.11) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.74,3.11) -- (3.90,3.11) -- (4.15,3.11);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.11) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (7,4\%)}};

% Amministratore
\fill[lineGray] (2.77,1.60) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.77,1.60) -- (3.90,1.60) -- (4.15,1.60);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.60) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}10 ore (18,5\%)}};

% Analista
\fill[lineGray] (3.15,-0.56) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.15,-0.56) -- (3.90,-0.56) -- (4.15,-0.56);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-0.56) {\bfseries Analista\\[1pt]{\small\color{lineGray}2 ore (3,7\%)}};

% Progettista
\fill[lineGray] (0.74,-3.11) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.74,-3.11) -- (3.90,-3.11) -- (4.15,-3.11);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-3.11) {\bfseries Progettista\\[1pt]{\small\color{lineGray}18 ore (33,3\%)}};

% Verificatore
\fill[lineGray] (-1.44,2.86) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.44,2.86) -- (-3.90,2.86) -- (-4.15,2.86);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.86) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}8 ore (14,8\%)}};

% Programmatore
\fill[lineGray] (-3.19,-0.19) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-3.19,-0.19) -- (-3.90,-0.19) -- (-4.15,-0.19);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-0.19) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}12 ore (22,2\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.19) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}2 ore (3,0\%)}};

% Amministratore
\fill[lineGray] (1.73,2.69) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.73,2.69) -- (3.90,2.14) -- (4.15,2.14);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.14) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}8 ore (12,1\%)}};

% Progettista
\fill[lineGray] (3.02,1.05) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.02,1.05) -- (3.90,1.05) -- (4.15,1.05);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,1.05) {\bfseries Progettista\\[1pt]{\small\color{lineGray}6 ore (9,1\%)}};

% Verificatore
\fill[lineGray] (-1.33,2.91) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.33,2.91) -- (-3.90,2.91) -- (-4.15,2.91);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.91) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}9 ore (13,6\%)}};

% Programmatore
\fill[lineGray] (-1.05,-3.02) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.05,-3.02) -- (-3.90,-3.02) -- (-4.15,-3.02);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.02) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}41 ore (62,1\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.16) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}3 ore (5,2\%)}};

% Amministratore
\fill[lineGray] (2.32,2.20) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.32,2.20) -- (3.90,2.11) -- (4.15,2.11);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.11) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}9 ore (15,5\%)}};

% Progettista
\fill[lineGray] (3.16,-0.52) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.16,-0.52) -- (3.90,-0.52) -- (4.15,-0.52);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-0.52) {\bfseries Progettista\\[1pt]{\small\color{lineGray}8 ore (13,8\%)}};

% Verificatore
\fill[lineGray] (-2.55,1.94) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.55,1.94) -- (-3.90,1.94) -- (-4.15,1.94);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,1.94) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}17 ore (29,3\%)}};

% Programmatore
\fill[lineGray] (-0.52,-3.16) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.52,-3.16) -- (-3.90,-3.16) -- (-4.15,-3.16);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.16) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}21 ore (36,2\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.17) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}3 ore (4,5\%)}};

% Amministratore
\fill[lineGray] (1.31,2.92) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.31,2.92) -- (3.90,2.12) -- (4.15,2.12);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.12) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}3 ore (4,5\%)}};

% Analista
\fill[lineGray] (3.13,0.67) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.13,0.67) -- (3.90,0.67) -- (4.15,0.67);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.67) {\bfseries Analista\\[1pt]{\small\color{lineGray}17 ore (25,4\%)}};

% Verificatore
\fill[lineGray] (-2.39,2.13) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.39,2.13) -- (-3.90,2.13) -- (-4.15,2.13);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.13) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}18 ore (26,9\%)}};

% Progettista
\fill[lineGray] (-0.74,-3.11) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.74,-3.11) -- (-3.90,-3.11) -- (-4.15,-3.11);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.11) {\bfseries Progettista\\[1pt]{\small\color{lineGray}26 ore (38,8\%)}};
...
\fill[lineGray] (3.19,0.19) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.19,0.19) -- (3.90,0.19) -- (4.15,0.19);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.19) {\bfseries Progettista\\[1pt]{\small\color{lineGray}24 ore (30,4\%)}};

% Verificatore
\fill[lineGray] (-2.19,2.33) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.19,2.33) -- (-3.90,2.33) -- (-4.15,2.33);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.33) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}19 ore (24,1\%)}};

% Programmatore
\fill[lineGray] (-1.47,-2.84) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.47,-2.84) -- (-3.90,-2.84) -- (-4.15,-2.84);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-2.84) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}29 ore (36,7\%)}};
...
\end{itemize}
I 2.875,00 € sono la somma dei monte ore per ruolo\textsubscript{G} valorizzati al rispettivo costo orario, compresa la voce negativa dell'Analista\textsubscript{G}. Le ore ancora a preventivo\textsubscript{G} saranno impiegate in prevalenza negli sprint\textsubscript{G} successivi, dedicati alla codifica\textsubscript{G} dell'MVP\textsubscript{G}, alla sua verifica\textsubscript{G} e al collaudo\textsubscript{G}. Il preventivo a finire aggiornato è riportato nella \hyperref[tab:preventivo-finire]{Sezione \S5.1}.
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,3.14) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}5 ore (6,0\%)}};

% Amministratore
\fill[lineGray] (1.60,2.77) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.60,2.77) -- (3.90,2.09) -- (4.15,2.09);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.09) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}4 ore (4,8\%)}};

% Progettista
\fill[lineGray] (3.12,0.71) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.12,0.71) -- (3.90,0.71) -- (4.15,0.71);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,0.71) {\bfseries Progettista\\[1pt]{\small\color{lineGray}18 ore (21,4\%)}};

% Verificatore
\fill[lineGray] (-2.00,2.50) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.00,2.50) -- (-3.90,2.50) -- (-4.15,2.50);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,2.50) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}18 ore (21,4\%)}};

% Programmatore
\fill[lineGray] (-1.06,-3.02) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.06,-3.02) -- (-3.90,-3.02) -- (-4.15,-3.02);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,-3.02) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}39 ore (46,4\%)}};
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-0.36) {\bfseries Progettista\\[1pt]{\small\color{lineGray}16 ore (28,6\%)}};

% Programmatore
\fill[lineGray] (0.00,-3.20) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.00,-3.20) -- (3.90,-3.20) -- (4.15,-3.20);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-3.20) {\bfseries Programmatore\\[1pt]{\small\color{lineGray}10 ore (17,9\%)}};

% Verificatore
\fill[lineGray] (-3.07,0.89) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-3.07,0.89) -- (-3.90,0.89) -- (-4.15,0.89);
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,0.89) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}23 ore (41,1\%)}};
...
Guardando all'intera fase di Product Baseline\textsubscript{G}, il gruppo osserva che l'accuratezza della pianificazione\textsubscript{G} è migliorata periodo dopo periodo, fino al pareggio di questo sprint\textsubscript{G}. È l'effetto combinato di alcune scelte adottate lungo il percorso: rendicontare le ore sul ruolo\textsubscript{G} effettivamente svolto, calibrare il preventivo\textsubscript{G} sulla disponibilità dichiarata in apertura di periodo, mettere a preventivo\textsubscript{G} anche le ore di chi opera come riserva e non impegnare l'intero budget residuo.

\subsubsection{Preventivo a finire (\hyperref[tab:preventivo-finire]{Sezione \S5.1})}
Al termine dello Sprint\textsubscript{G} \#11 risultano consuntivate 608 ore delle 623 preventivate\textsubscript{G}. Applicando il criterio seguito fin dallo Sprint\textsubscript{G} \#8, per cui il preventivo a finire è la semplice differenza fra ore preventivate\textsubscript{G} e ore consuntivate, senza ricalibrazioni, restano 15 ore così ripartite: Responsabile\textsubscript{G} 5 ore, Amministratore\textsubscript{G} $-1$, Analista\textsubscript{G} $-9$, Progettista\textsubscript{G} 5, Programmatore\textsubscript{G} 6 e Verificatore\textsubscript{G} 9.

Restando un solo periodo, quel criterio esaurisce la propria utilità: non ci sono più sprint\textsubscript{G} successivi in cui assorbire le poste negative, né attività che possano consumare le dotazioni ancora ferme su ruoli\textsubscript{G} ormai conclusi. Il gruppo interviene pertanto sul preventivo\textsubscript{G} iniziale, ricalibrando tre voci:
\begin{itemize}
    \item \textbf{Analista\textsubscript{G}: si aggiungono 9 ore}, tante quante il debito accumulato sul ruolo\textsubscript{G}, che chiude così esattamente a zero. Il lavoro sui requisiti\textsubscript{G} si è concluso negli sprint\textsubscript{G} precedenti e non sono previsti ulteriori interventi sull'analisi\textsubscript{G}: solo ora che questa certezza esiste il debito può essere ripianato senza rischiare di doverlo riaprire;

    \item \textbf{Amministratore\textsubscript{G}: si aggiungono 4 ore}. Una copre il debito maturato sul ruolo\textsubscript{G}, le altre tre coprono la pubblicazione dei documenti della Product Baseline\textsubscript{G} e gli ultimi aggiornamenti del sito, attività previste nello Sprint\textsubscript{G} \#12 e prive di dotazione residua;
...
A valle della ricalibrazione il monte ore complessivo del progetto passa da 623 a \textbf{630 ore} e il budget da 12.335,00 € a 12.550,00 €. Il preventivo a finire vale \textbf{22 ore per 470,00 €}, ripartite fra Responsabile\textsubscript{G} 5 ore, Amministratore\textsubscript{G} 3, Progettista\textsubscript{G} 5 e Verificatore\textsubscript{G} 9, mentre Analista\textsubscript{G} e Programmatore\textsubscript{G} chiudono a zero. Sono le sole voci su cui lo Sprint\textsubscript{G} \#12 potrà attingere. Il preventivo a finire aggiornato è riportato nella \hyperref[tab:preventivo-finire]{Sezione \S5.1}.
...
\node[anchor=west, align=left, inner sep=2pt] at (4.25,2.64) {\bfseries Responsabile\\[1pt]{\small\color{lineGray}4 ore (20,0\%)}};

% Amministratore
\fill[lineGray] (3.19,-0.24) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.19,-0.24) -- (3.90,-0.24) -- (4.15,-0.24);
\node[anchor=west, align=left, inner sep=2pt] at (4.25,-0.24) {\bfseries Amministratore\\[1pt]{\small\color{lineGray}3 ore (15,0\%)}};
...
\node[anchor=east, align=right, inner sep=2pt] at (-4.25,1.17) {\bfseries Verificatore\\[1pt]{\small\color{lineGray}8 ore (40,0\%)}};
...
Di seguito è riportato il consuntivo economico del dodicesimo sprint\textsubscript{G}:
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.4}
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Amministratore & 3 & 0 & 60,00 & 0,00 \\ \hline
        Analista & 0 & 0 & 0,00 & 0,00 \\ \hline
        Progettista & 5 & 0 & 125,00 & 0,00 \\ \hline
        Programmatore & 0 & 0 & 0,00 & 0,00 \\ \hline
        Verificatore & 8 & 0 & 120,00 & 0,00 \\ \hline
        ...
        Sprint pregressi & 608 & / & 12.080,00 & / \\ \hline
...
\subsubsection{Consuntivo di periodo}
Il dodicesimo sprint\textsubscript{G} è il periodo conclusivo del progetto ed è dedicato alla comunicazione con la Proponente\textsubscript{G}, all'organizzazione della presentazione della Product Baseline\textsubscript{G} e ai controlli finali. \textbf{Tutte le attività individuate sono state completate} e nessuna è stata rimandata. Le attività svolte sono state:
\begin{itemize}
    \item stesura del verbale\textsubscript{G} interno relativo alla riunione di apertura dello sprint\textsubscript{G} del 2026-08-18, secondo quanto previsto dalle \textit{Norme di Progetto};

    \item preparazione e invio alla Proponente\textsubscript{G} del \textbf{video dimostrativo} del prodotto in esecuzione, corredato dal collegamento alla repository\textsubscript{G} dell'MVP\textsubscript{G} e al \textit{Manuale Utente}, dal resoconto dei requisiti\textsubscript{G} funzionali e non funzionali soddisfatti e dal riepilogo delle tecnologie impiegate. Il dettaglio del materiale trasmesso e dei contenuti illustrati è riportato nel verbale\textsubscript{G} esterno di approvazione dell'MVP\textsubscript{G} del 2026-08-21;

    \item \textbf{ricezione del riscontro positivo della Proponente\textsubscript{G}}: il referente aziendale ha preso visione del materiale trasmesso, manifestando soddisfazione per i risultati conseguiti e confermando formalmente l'approvazione e l'accettazione dell'MVP\textsubscript{G} \textit{Second Brain}. Il relativo verbale\textsubscript{G} esterno costituisce evidenza dell'accettazione formale del prodotto da parte dell'azienda proponente;

    \item \textbf{richiesta formale al prof. Riccardo Cardin} per lo svolgimento della prima parte della presentazione della Product Baseline\textsubscript{G}, fissata per il 2026-08-26;
    ...
    \item \textbf{riunioni interne di allineamento} dedicate all'organizzazione dell'esposizione, alla ripartizione delle parti da presentare, al chiarimento dei dubbi emersi e alla verifica\textsubscript{G} che tutti i membri avessero acquisito i concetti da esporre;

    \item ultimi controlli formali e contenutistici sugli artefatti\textsubscript{G} destinati alla Product Baseline\textsubscript{G}, illustrati nel paragrafo seguente;
...
\begin{itemize}
    \item \textbf{Il periodo chiude sostanzialmente in linea con il preventivo\textsubscript{G}:} l'unico scostamento\textsubscript{G} riguarda il ruolo Progettista\textsubscript{G}, che ha richiesto qualche ora in più per la preparazione delle diapositive sull'architettura\textsubscript{G}. È ancora una volta un'attività senza precedenti nel progetto, la categoria che il gruppo ha sottostimato con maggiore regolarità, e il margine che era stato accantonato in apertura di periodo è bastato ad assorbirla;

    \item \textbf{La pianificazione\textsubscript{G} flessibile si è rivelata adeguata:} la scelta di non fissare task rigidi in apertura di periodo, mantenendo il coordinamento su riunioni interne di allineamento ricorrenti, era la risposta alle due incertezze esterne descritte negli obiettivi. Entrambe si sono risolte entro il periodo e la modalità adottata non ha generato tempi morti né rilavorazioni: le decisioni sono state assunte man mano che le informazioni diventavano disponibili;

    \item \textbf{L'unica incertezza rilevante si è chiusa favorevolmente:} l'attesa del riscontro della Proponente\textsubscript{G} si è conclusa con l'approvazione formale dell'MVP\textsubscript{G} e non ha comportato alcuna richiesta di modifica al prodotto o alla documentazione. La capacità di verifica\textsubscript{G} accantonata per questa eventualità non è stata pertanto assorbita da interventi correttivi ed è stata destinata ai controlli conclusivi;

    \item \textbf{I controlli finali non hanno prodotto rilievi:} le verifiche\textsubscript{G} sul documento di \textit{Specifica Tecnica} e sul codice sorgente hanno confermato lo stato degli artefatti\textsubscript{G} senza richiedere modifiche sostanziali. Il gruppo valuta positivamente il dato, che discende dalla scelta, assunta a fine Sprint\textsubscript{G} \#10, di allineare la documentazione al codice entro il periodo in cui la modifica viene introdotta anziché rimandarne il recepimento;

    \item \textbf{La ricalibrazione delle dotazioni andava anticipata:} l'intervento deliberato alla chiusura dello Sprint\textsubscript{G} \#11 ha reso di nuovo leggibile il preventivo a finire, ma il gruppo riconosce che sarebbe stato utile già al termine dello Sprint\textsubscript{G} \#10. Il debito dell'Analista\textsubscript{G} era interamente maturato dallo Sprint\textsubscript{G} \#8 e permaneva invariato, e la sua presenza ha reso meno leggibile il prospetto dei periodi conclusivi, poiché il monte ore residuo comprendeva poste su ruoli\textsubscript{G} che non sarebbero più stati esercitati;

    \item \textbf{Assegnare le attività guardando al residuo individuale ha funzionato:} nel periodo conclusivo le attività sono state distribuite in base a quanto ciascun membro aveva ancora disponibile, e non alla sola rotazione dei ruoli\textsubscript{G}. La misura recepisce l'avvertenza formulata al termine dello Sprint\textsubscript{G} \#11 sulla distribuzione disomogenea delle ore residue e ha permesso a tutti i componenti di chiudere il progetto avendo svolto almeno il proprio monte ore individuale.
\end{itemize}

\paragraph{Aggiornamento dell'analisi dei rischi (\hyperref[tab:gestione-rischi]{Sezione \S2})}
Lo Sprint\textsubscript{G} \#12 non modifica la valutazione dei rischi\textsubscript{G} censiti nella \hyperref[tab:gestione-rischi]{Sezione \S2}. Trattandosi del periodo conclusivo, si riportano le osservazioni finali sui rischi\textsubscript{G} rimasti attivi:
\begin{itemize}
    \item \textbf{RO-1 -- Periodi di rallentamento:} il rischio\textsubscript{G} non si è manifestato, pur cadendo il periodo interamente nel mese indicato come critico. La disponibilità dichiarata in apertura di sprint\textsubscript{G} è stata rispettata da tutti i membri;

    \item \textbf{RT-3 -- Presenza di errori nel codice:} il rischio\textsubscript{G} non si è manifestato. Le verifiche\textsubscript{G} conclusive sul codice sorgente non hanno prodotto rilievi e nessun difetto è rimasto aperto alla chiusura del progetto;

    \item \textbf{RO-8 -- Errata stima delle attività:} il rischio\textsubscript{G} si è ripresentato in forma contenuta sul ruolo Progettista\textsubscript{G}, ancora una volta su un'attività priva di precedenti storici nel progetto, ossia la preparazione delle diapositive. Lo scostamento\textsubscript{G} è stato assorbito dal margine accantonato in apertura di periodo e non ha avuto conseguenze sulla chiusura del progetto.
\end{itemize}

\subsubsection{Riepilogo totale delle ore consuntivate per componente e ruolo}
Essendo lo Sprint\textsubscript{G} \#12 l'ultimo periodo di lavoro, di seguito viene riportata la tabella riassuntiva definitiva con il totale delle ore effettivamente utilizzate da ogni singolo componente per ciascun ruolo durante l'intero arco del progetto. 

Come si può evincere dai totali, \textbf{nessun componente è sceso sotto la soglia minima delle 89 ore} richieste. A. Marini (92 ore), E. De Piccoli (90 ore) e S. Vendramin (90 ore) hanno assorbito ore aggiuntive per garantire il completamento delle attività di codifica e di verifica nelle fasi più critiche, portando il totale generale consuntivato a 628 ore.
...
Questo sprint\textsubscript{G} ha rappresentato l’ultima iterazione del progetto didattico, durante la quale il team ha finalizzato e perfezionato tutto il materiale necessario per la presentazione e la consegna della Product Baseline\textsubscript{G}.

Giunti al termine di questo percorso, il gruppo \textbf{The Bitless} ha compreso a fondo cosa significhi effettivamente lo sviluppo di un prodotto software all'interno di un team strutturato. Abbiamo toccato con mano come la sola scrittura del codice sia appena una frazione del lavoro: la stesura rigorosa della documentazione, il coordinamento continuo, il controllo qualità, l'adattamento ai requisiti in evoluzione e la gestione preventiva dei rischi si sono rivelati gli elementi centrali per la buona riuscita del progetto.
...
\paragraph{Pianificazione futura}
Il team conclude definitivamente lo sviluppo del progetto e la produzione documentale con il completamento della Product Baseline\textsubscript{G}, che sarà formalmente finalizzata e consegnata la prossima settimana, a valle del colloquio conclusivo con il prof. Tullio Vardanega. 

Essendo lo Sprint\textsubscript{G} \#12 l'ultima iterazione del progetto, non sono previsti ulteriori cicli di sviluppo o nuove pianificazioni operative: il gruppo ha esaurito i task in carico e le energie nei giorni che ci separano dalla consegna ufficiale saranno concentrate unicamente sul buon esito dell'esposizione finale.
