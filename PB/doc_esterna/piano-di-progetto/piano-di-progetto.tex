...
In apertura dello Sprint\textsubscript{G} \#12 la ripartizione è stata sottoposta a una \textbf{rettifica conclusiva}: il monte ore complessivo resta di 623 ore e il carico individuale di 89 ore per componente, mentre la distribuzione fra i ruoli\textsubscript{G} viene allineata all'impiego effettivamente rilevato lungo il progetto. Il ruolo Analista\textsubscript{G} passa da 62 a 71 ore, recependo le 9 ore eccedenti maturate nello Sprint\textsubscript{G} \#8 sulla revisione dei requisiti\textsubscript{G} non funzionali, e l'Amministratore\textsubscript{G} da 60 a 61; per contro il Programmatore\textsubscript{G} scende da 158 a 152 ore, il Progettista\textsubscript{G} da 135 a 133, il Verificatore\textsubscript{G} da 160 a 159 e il Responsabile\textsubscript{G} da 48 a 47, essendo tali dotazioni risultate sovrastimate. La rettifica non altera il monte ore complessivo ma ne modifica la valorizzazione, che passa da 12.335,00 € a \textbf{12.395,00 €} per effetto del diverso costo orario dei ruoli\textsubscript{G} coinvolti. Motivazioni ed effetti sono illustrati nel preventivo\textsubscript{G} dello Sprint\textsubscript{G} \#12.

\textbf{Ultimo aggiornamento: 2026-08-24}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        Amministratore & 61 & 20,00 & 1.220,00 \\ \hline
        Analista & 71 & 25,00 & 1.775,00 \\ \hline
        Progettista & 133 & 25,00 & 3.325,00 \\ \hline
        Programmatore & 152 & 15,00 & 2.280,00 \\ \hline
        Verificatore & 159 & 15,00 & 2.385,00 \\ \hline
        \rowcolor[HTML]{EFEFEF}
        \textbf{Totale} & \textbf{623} & \textbf{--} & \textbf{12.395,00} \\ \hline
    \end{tabular}
...
Di seguito è riportato il preventivo ``a finire'', ovvero la stima delle ore e dei costi ancora necessari al completamento del progetto, soggetto a miglioramento continuo in base alle considerazioni del consuntivo di periodo. Al termine dello Sprint\textsubscript{G} \#12, ultimo periodo del progetto, risultano consuntivate 623 ore delle 623 preventivate: \textbf{il monte ore è integralmente impiegato, il prospetto si azzera in ogni sua voce e non residuano né ore né costi}.

Per tutta la durata del progetto il prospetto ha riportato la differenza fra le ore preventivate\textsubscript{G} per ciascuna coppia risorsa-ruolo e quelle effettivamente consuntivate, senza alcuna ricalibrazione. Il gruppo ha deliberatamente scelto di non ripianare in corso d'opera i valori negativi mediante ridistribuzioni fra ruoli: un preventivo a finire costruito a posteriori perderebbe il proprio valore diagnostico e nasconderebbe l'informazione più rilevante, ossia quali ruoli\textsubscript{G} e quali membri abbiano già eroso il proprio budget. I valori negativi sono stati quindi letti come un debito maturato sulla coppia risorsa-ruolo, da compensare all'occorrenza sottraendo ore ad altre voci nel periodo in cui il fabbisogno si presentasse.

Alla chiusura del progetto quella funzione diagnostica si esaurisce: non esistendo periodi successivi in cui assorbire le poste residue, conservarle non fornirebbe più alcuna indicazione utile alla pianificazione\textsubscript{G}. In apertura dello Sprint\textsubscript{G} \#12 il gruppo ha pertanto deliberato una \textbf{rettifica conclusiva della ripartizione del budget}, allineando la dotazione di ciascuna coppia risorsa-ruolo all'impiego effettivamente rilevato. La rettifica lascia invariati il monte ore complessivo, pari a 623 ore, e il carico individuale, pari a 89 ore per componente, e si limita a spostare ore fra i ruoli\textsubscript{G} all'interno di ciascun membro; la sua incidenza sulla stima dei costi per ruolo è illustrata nella \hyperref[sec:stima-costi]{Sezione \S5}.

Le poste composte dalla rettifica erano 9 ore in eccesso sull'Analista\textsubscript{G} e una sull'Amministratore\textsubscript{G}, a fronte di 6 ore non utilizzate sul Programmatore\textsubscript{G}, 2 sul Progettista\textsubscript{G} e una ciascuno su Responsabile\textsubscript{G} e Verificatore\textsubscript{G}. Il gruppo osserva che l'intervento avrebbe potuto essere anticipato: il debito dell'Analista\textsubscript{G}, maturato nello Sprint\textsubscript{G} \#8 sulla revisione dei requisiti\textsubscript{G} non funzionali, era già stabile a $-9$ ore dallo Sprint\textsubscript{G} \#10, e una rettifica in quella sede avrebbe restituito un preventivo a finire più aderente al fabbisogno residuo dei periodi conclusivi.

\textbf{Tutti i membri del gruppo chiudono il progetto a saldo nullo su ogni ruolo\textsubscript{G}}: ciascuno ha portato a termine le 89 ore complessivamente assegnate e nessuna coppia risorsa-ruolo presenta ore residue, né in credito né in debito. Il costo complessivo consuntivato, pari a 12.395,00 €, coincide con il budget rettificato: lo scostamento\textsubscript{G} conclusivo del progetto è nullo tanto sulle ore quanto sui costi.
...
La composizione dei ruoli\textsubscript{G} recepisce quanto stabilito nella riunione di apertura: \textbf{risultano attivi tre soli ruoli\textsubscript{G}}, ossia Responsabile\textsubscript{G}, Progettista\textsubscript{G} e Verificatore\textsubscript{G}. E. De Piccoli ricopre il doppio ruolo\textsubscript{G} di Responsabile\textsubscript{G} e Progettista\textsubscript{G}, S. Zecchinato quello di Progettista\textsubscript{G}, mentre L. Battistella, D. Facco e A. Menegaldo operano come Verificatori\textsubscript{G}. A. Marini e S. Vendramin non ricoprono alcun ruolo\textsubscript{G}, avendo esaurito nei periodi precedenti la quota di ore complessivamente prevista per il progetto. Amministratore\textsubscript{G}, Analista\textsubscript{G} e Programmatore\textsubscript{G} restano a zero ore, non essendo previste attività di configurazione\textsubscript{G}, di analisi\textsubscript{G} o di codifica\textsubscript{G}.

Nella medesima riunione il gruppo ha inoltre deliberato la \textbf{rettifica conclusiva della ripartizione del budget per ruolo\textsubscript{G}}, illustrata nel preventivo\textsubscript{G} del periodo. Non essendovi periodi successivi in cui assorbire le poste residue, la dotazione di ciascuna coppia risorsa-ruolo viene allineata all'impiego effettivo, a parità di monte ore complessivo e di carico individuale.
...
% Settori (Totale = 15 ore)
% Re: 4 ore -> 26,7%
% Pt: 3 ore -> 20,0%
% Ve: 8 ore -> 53,3%

\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90:\r) arc[start angle=90,end angle=-6,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (-6:\r) arc[start angle=-6,end angle=-78,radius=\r] -- cycle;

\path[fill=colVer, draw=white, line width=1.5pt]
(0,0) -- (-78:\r) arc[start angle=-78,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (42:1.85) {26,7\%};
\node[font=\small\bfseries] at (-42:1.85) {20,0\%};
\node[font=\small\bfseries] at (-174:1.85) {53,3\%};

% Etichette esterne
% Responsabile (alto destra)
\fill[lineGray] (1.26,1.14) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.26,1.14) -- (5.5,2.2);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,2.27) {Responsabile};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,2.05) {4 ore};

% Progettista (basso destra)
\fill[lineGray] (1.26,-1.14) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.26,-1.14) -- (5.5,-1.2);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,-1.13) {Progettista};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,-1.35) {3 ore};

% Verificatore (sinistra)
\fill[lineGray] (-1.69,-0.18) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.69,-0.18) -- (-5.5,0.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,0.47) {Verificatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,0.25) {8 ore};
...
Il preventivo\textsubscript{G} dello Sprint\textsubscript{G} \#12 ammonta a 15 ore produttive, pari all'intero monte ore residuo al termine dello Sprint\textsubscript{G} \#11. È il preventivo\textsubscript{G} più contenuto dell'intero progetto e ne costituisce, per costruzione, la chiusura: non essendo previste attività di produzione, la dotazione copre le sole attività di coordinamento, di rappresentanza e di controllo conclusivo.

Il gruppo dà atto di uno \textbf{scostamento\textsubscript{G} consapevole} rispetto all'indicazione formulata al termine dello Sprint\textsubscript{G} \#11, che suggeriva di impegnare al massimo 12 ore conservando un margine di 3 fino alla consegna. Quell'indicazione era stata assunta quando il riscontro della Proponente\textsubscript{G} era ancora atteso e l'eventualità di dover recepire modifiche al prodotto rendeva prudente accantonare una riserva oltre la chiusura del periodo. Trattandosi dell'ultimo sprint\textsubscript{G} del progetto, il gruppo ha preferito destinargli l'intero residuo, così che la riserva restasse disponibile \emph{all'interno} del periodo: ore non impegnate in questa sede non sarebbero state utilizzabili altrove.

La ripartizione fra i membri non segue una divisione aritmetica del monte ore di ciascun ruolo\textsubscript{G}, bensì il criterio della \textbf{coerenza con il residuo individuale}: a ogni membro sono assegnate esattamente le ore ancora disponibili sul proprio bilancio personale, così che il periodo conclusivo porti tutti i componenti a saldo nullo. Le 8 ore del Verificatore\textsubscript{G} sono quindi ripartite fra D. Facco (4 ore), A. Menegaldo (3 ore) e L. Battistella (1 ora); le 3 ore del Progettista\textsubscript{G} fra E. De Piccoli (2 ore) e S. Zecchinato (1 ora); le 4 ore del Responsabile\textsubscript{G} sono interamente in capo a E. De Piccoli, che ricopre il doppio ruolo\textsubscript{G}. Il criterio recepisce l'avvertenza formulata nel preventivo a finire al termine dello Sprint\textsubscript{G} \#11, dove si segnalava che il vincolo stringente del periodo conclusivo non è il monte ore complessivo, bensì la sua distribuzione fra i membri.

Il ruolo Verificatore\textsubscript{G} assorbe 8 ore, pari al 53,3\% del preventivo\textsubscript{G}, ed è la voce più capiente del periodo: la dotazione è destinata agli ultimi controlli formali e contenutistici sul documento di \textit{Specifica Tecnica} e sul codice sorgente. Le 4 ore del Responsabile\textsubscript{G} (26,7\%) coprono la gestione della comunicazione con la Proponente\textsubscript{G} e la richiesta al prof. Riccardo Cardin, mentre le 3 ore del Progettista\textsubscript{G} (20,0\%) sono riservate alla predisposizione delle diapositive sull'architettura\textsubscript{G} del software.

Il preventivo\textsubscript{G} valorizza le 15 ore residue in 315,00 €, a fronte dei 255,00 € iscritti nel preventivo a finire al termine dello Sprint\textsubscript{G} \#11. La differenza di 60,00 € non deriva da ore aggiuntive, poiché il monte ore coincide, bensì dalla composizione per ruolo\textsubscript{G} del residuo: esso comprendeva 6 ore di Programmatore\textsubscript{G} a 15,00 €/ora e la posta negativa dell'Analista\textsubscript{G} ($-9$ ore a 25,00 €/ora), mentre le ore effettivamente impegnate nel periodo gravano sui ruoli\textsubscript{G} più onerosi.

Per questa ragione, in apertura di periodo il gruppo ha deliberato la \textbf{rettifica conclusiva della ripartizione del budget per ruolo\textsubscript{G}}. Trattandosi dell'ultimo sprint\textsubscript{G}, non esistono periodi successivi in cui assorbire le poste residue: conservare una dotazione teorica su ruoli\textsubscript{G} che non verranno più esercitati, e un debito su ruoli\textsubscript{G} ormai conclusi, renderebbe il preventivo a finire non interpretabile. La dotazione di ciascuna coppia risorsa-ruolo è stata pertanto allineata all'impiego effettivo: l'Analista\textsubscript{G} sale da 62 a 71 ore e l'Amministratore\textsubscript{G} da 60 a 61, mentre Programmatore\textsubscript{G} ($-6$ ore), Progettista\textsubscript{G} ($-2$), Responsabile\textsubscript{G} ($-1$) e Verificatore\textsubscript{G} ($-1$) restituiscono le ore non utilizzate. Il monte ore complessivo resta di 623 ore e il carico individuale di 89 ore per componente, mentre la valorizzazione del budget passa da 12.335,00 € a 12.395,00 €, per effetto del maggior costo orario dei ruoli\textsubscript{G} che assorbono le ore.

A valle della rettifica il preventivo a finire coincide esattamente con il preventivo\textsubscript{G} del periodo conclusivo: 15 ore per 315,00 €, ripartite in 4 ore di Responsabile\textsubscript{G}, 3 di Progettista\textsubscript{G} e 8 di Verificatore\textsubscript{G}. Il gruppo osserva che l'intervento avrebbe potuto essere anticipato allo Sprint\textsubscript{G} \#10, quando il debito dell'Analista\textsubscript{G} era già interamente maturato e stabile a $-9$ ore.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline
        Responsabile di progetto & 4 & 120,00 \\ \hline
        Amministratore & 0 & 0,00 \\ \hline
        Analista & 0 & 0,00 \\ \hline
        Progettista & 3 & 75,00 \\ \hline
        Programmatore & 0 & 0,00 \\ \hline
        Verificatore & 8 & 120,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{15} & \textbf{315,00} \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|}
        ...
        \textbf{\shortstack{Delta costo\\(in €)}} \\
        \hline
        Responsabile di progetto & 4 & 4 & 0 & 120,00 & 120,00 & 0,00 \\ \hline
        Amministratore & 0 & 0 & 0 & 0,00 & 0,00 & 0,00 \\ \hline
        Analista & 0 & 0 & 0 & 0,00 & 0,00 & 0,00 \\ \hline
        Progettista & 3 & 3 & 0 & 75,00 & 75,00 & 0,00 \\ \hline
        Programmatore & 0 & 0 & 0 & 0,00 & 0,00 & 0,00 \\ \hline
        Verificatore & 8 & 8 & 0 & 120,00 & 120,00 & 0,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{15} & \textbf{15} & \textbf{0} & \textbf{315,00} & \textbf{315,00} & \textbf{0,00} \\ \hline
    \end{tabular}
    \caption{\textit{Riepilogo preventivo-consuntivo per ruolo dello Sprint \#12}}
\end{table}

Lo Sprint\textsubscript{G} \#12 chiude in \textbf{perfetto pareggio, tanto sul piano delle ore quanto su quello economico}. A differenza dello Sprint\textsubscript{G} \#11, che aveva raggiunto il pareggio orario per compensazione fra scostamenti\textsubscript{G} di segno opposto, in questo periodo \textbf{nessun ruolo\textsubscript{G} si discosta dalla propria dotazione}: il pareggio è integrale e si verifica voce per voce. Ciò vale anche a livello di singolo membro, poiché ogni componente ha rendicontato esattamente le ore che gli erano state assegnate in sede di preventivo\textsubscript{G}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Responsabile di progetto & 4 & 0 & 120,00 & 0,00 \\ \hline
        Amministratore & 0 & 0 & 0,00 & 0,00 \\ \hline
        Analista & 0 & 0 & 0,00 & 0,00 \\ \hline
        Progettista & 3 & 0 & 75,00 & 0,00 \\ \hline
        Programmatore & 0 & 0 & 0,00 & 0,00 \\ \hline
        Verificatore & 8 & 0 & 120,00 & 0,00 \\ \hline

        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{15} & \textbf{0} & \textbf{315,00} & \textbf{0,00} \\ \hline

        Sprint pregressi & 608 & / & 12.080,00 & / \\ \hline
        Totale di progetto & 623 & / & 12.395,00 & / \\ \hline
        Restante & 0 & / & 0,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        E. De Piccoli & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        D. Facco & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        A. Marini & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        A. Menegaldo & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        S. Vendramin & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        S. Zecchinato & 0 & 0 & 0 & 0 & 0 & 0 & \textbf{0} \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{0} & \textbf{0} & \textbf{0} & \textbf{0} & \textbf{0} & \textbf{0} & \textbf{0} \\
        \hline
    \end{tabular}
    \caption{\textit{Ore rimanenti per coppia risorsa-ruolo dopo lo Sprint \#12}}
\end{table}

\textbf{Tutti i membri del gruppo hanno portato a termine l'intero monte ore individuale previsto per il progetto, pari a 89 ore ciascuno, e il prospetto si azzera in ogni sua voce: nessuna coppia risorsa-ruolo presenta ore residue, né in credito né in debito.} Il risultato recepisce la rettifica conclusiva della ripartizione del budget deliberata in apertura di periodo e illustrata nel preventivo\textsubscript{G} dello Sprint\textsubscript{G} \#12, che ha allineato la dotazione di ciascuna coppia risorsa-ruolo all'impiego effettivo. Le poste composte dalla rettifica erano lo scarto fra il ruolo\textsubscript{G} preventivato\textsubscript{G} e quello effettivamente esercitato, accumulato lungo l'intero progetto per effetto della rotazione dei ruoli\textsubscript{G} e degli interventi di supporto fuori ruolo\textsubscript{G} registrati a partire dallo Sprint\textsubscript{G} \#8: 9 ore in eccesso sull'Analista\textsubscript{G} e una sull'Amministratore\textsubscript{G}, a fronte di 6 ore non utilizzate sul Programmatore\textsubscript{G}, 2 sul Progettista\textsubscript{G} e una ciascuno su Responsabile\textsubscript{G} e Verificatore\textsubscript{G}.
...
Le \textbf{8 ore del ruolo Verificatore\textsubscript{G} sono state interamente impiegate negli ultimi controlli formali e contenutistici} sul documento di \textit{Specifica Tecnica}, sottoposto a un'ultima revisione, e nelle verifiche\textsubscript{G} conclusive sul codice sorgente. I controlli non hanno prodotto modifiche sostanziali: la stesura e la correzione degli artefatti\textsubscript{G} erano già state completate nei periodi precedenti e la dotazione del ruolo\textsubscript{G} è servita a confermarne l'esito, non a rilavorarlo. L'assenza di rilievi in questa fase va letta come il risultato atteso dell'attività di verifica\textsubscript{G} continuativa condotta negli sprint\textsubscript{G} precedenti, e non come una sottoutilizzazione del ruolo\textsubscript{G}.

A fronte di 15 ore preventivate\textsubscript{G} ne sono state consuntivate\textsubscript{G} 15, con uno \textbf{scostamento\textsubscript{G} nullo} ($0{,}0\%$) e un costo di 315,00 €, anch'esso coincidente con la stima. Con questo periodo le ore consuntivate del progetto salgono a \textbf{623 delle 623 preventivate\textsubscript{G}}: il monte ore è integralmente impiegato e non residuano ore disponibili. Il costo complessivo consuntivato ammonta a 12.395,00 € e \textbf{coincide con il budget rettificato} in apertura di periodo, con scostamento\textsubscript{G} nullo. Rispetto alla valorizzazione precedente la rettifica, pari a 12.335,00 €, l'incremento è di 60,00 €, ossia lo $0{,}49\%$: come illustrato nel preventivo\textsubscript{G} del periodo, esso non deriva da ore eccedenti, bensì dall'aver esercitato ruoli\textsubscript{G} mediamente più onerosi di quelli ipotizzati all'avvio del progetto.
...
\begin{itemize}
    \item \textbf{Le ore rendicontate corrispondono perfettamente a quelle preventivate\textsubscript{G}:} è l'unico periodo del progetto in cui il pareggio si verifica su ogni singolo ruolo\textsubscript{G} e su ogni singolo membro, e non per compensazione fra scostamenti\textsubscript{G} di segno opposto come nello Sprint\textsubscript{G} \#11. Il risultato è agevolato dalla natura non produttiva del periodo, ma conferma l'efficacia delle misure di calibrazione adottate a partire dallo Sprint\textsubscript{G} \#8;
    ...
    \item \textbf{La rettifica del budget andava anticipata:} l'allineamento della ripartizione per ruolo\textsubscript{G} all'impiego effettivo, deliberato in apertura di questo periodo, ha permesso di chiudere il preventivo a finire a zero su ogni voce. Il gruppo riconosce però che l'intervento sarebbe stato utile già al termine dello Sprint\textsubscript{G} \#10: il debito di 9 ore dell'Analista\textsubscript{G} era interamente maturato dallo Sprint\textsubscript{G} \#8 e permaneva invariato, e la sua presenza ha reso il preventivo a finire dei periodi conclusivi meno leggibile, poiché il monte ore residuo comprendeva poste su ruoli\textsubscript{G} che non sarebbero più stati esercitati;

    \item \textbf{Il criterio di ripartizione per residuo ha azzerato i saldi individuali:} assegnando a ciascun membro esattamente le ore ancora disponibili sul proprio bilancio, il periodo conclusivo ha portato tutti i componenti a saldo nullo. La misura recepisce l'avvertenza formulata al termine dello Sprint\textsubscript{G} \#11 sulla distribuzione disomogenea delle ore residue.
\end{itemize}
...
\begin{itemize}
    \item \textbf{RP-2 -- Indisponibilità della Proponente\textsubscript{G}:} il rischio\textsubscript{G}, manifestatosi nello Sprint\textsubscript{G} \#11 con il periodo di ferie estive del referente aziendale, si chiude definitivamente con l'approvazione formale dell'MVP\textsubscript{G} del 2026-08-19. La contromisura adottata, ossia il passaggio a una modalità di confronto asincrona concordata con il referente, si è rivelata efficace: il riscontro è stato ottenuto entro il periodo e senza rallentare l'avanzamento dei lavori;

    \item \textbf{RO-1 -- Periodi di rallentamento:} il rischio\textsubscript{G} non si è manifestato, pur cadendo il periodo interamente nel mese indicato come critico. La disponibilità dichiarata in apertura di sprint\textsubscript{G} è stata rispettata da tutti i membri e lo scostamento\textsubscript{G} del periodo è nullo;
    ...
    \item \textbf{RO-8 -- Errata stima delle attività:} il rischio\textsubscript{G} non si è manifestato. Il periodo chiude con scostamento\textsubscript{G} nullo su ogni ruolo\textsubscript{G}, il valore migliore dell'intero progetto insieme a quello dello Sprint\textsubscript{G} \#11.
\end{itemize}

\subsubsection{Bilancio conclusivo del progetto}
Con lo Sprint\textsubscript{G} \#12 il progetto si chiude. Il monte ore complessivo è stato impiegato integralmente, 623 ore su 623 preventivate\textsubscript{G}, e ciascun componente ha portato a termine le 89 ore che gli erano state assegnate. Il costo consuntivato è di 12.395,00 € e coincide con il budget rettificato in apertura del periodo conclusivo; rispetto alla valorizzazione iniziale di 12.335,00 € l'incremento è di 60,00 €, pari allo $0{,}49\%$, imputabile alla composizione dei ruoli\textsubscript{G} effettivamente esercitati e non a un maggior impiego di risorse.

Sul piano dell'accuratezza della pianificazione\textsubscript{G}, la fase di Product Baseline\textsubscript{G} mostra scostamenti\textsubscript{G} percentuali costantemente contenuti e in miglioramento: $+6{,}3\%$ nello Sprint\textsubscript{G} \#8, $+1{,}3\%$ nello Sprint\textsubscript{G} \#9, $+3{,}7\%$ nello Sprint\textsubscript{G} \#10, $0{,}0\%$ nello Sprint\textsubscript{G} \#11 e $0{,}0\%$ nello Sprint\textsubscript{G} \#12, con una media del $2{,}3\%$. Le cinque misure che hanno inciso maggiormente sono state la rendicontazione sul ruolo\textsubscript{G} effettivamente svolto (Sprint\textsubscript{G} \#8), la calibrazione del preventivo\textsubscript{G} sulle ore dichiarate in apertura di periodo (Sprint\textsubscript{G} \#9), la messa a preventivo\textsubscript{G} delle ore del membro di riserva (Sprint\textsubscript{G} \#10), la scelta di non impegnare l'intero budget residuo (Sprint\textsubscript{G} \#11) e la ripartizione delle ore per residuo individuale (Sprint\textsubscript{G} \#12).

Resta da svolgere la sola presentazione della Product Baseline\textsubscript{G}: la prima parte è fissata con il prof. Riccardo Cardin per il 2026-08-26, cui seguirà la consegna finale al prof. Tullio Vardanega.

\subsubsection{Preventivo a finire (\hyperref[tab:preventivo-finire]{Sezione \S5.1})}
Al termine dello Sprint\textsubscript{G} \#12 risultano consuntivate 623 ore delle 623 preventivate\textsubscript{G}: \textbf{il preventivo a finire si azzera in ogni sua voce} e non residuano né ore né costi. Il monte ore complessivo del progetto resta 623 ore e il budget, rettificato in apertura di periodo, ammonta a 12.395,00 €.

Per tutta la durata del progetto il preventivo a finire è stato la semplice differenza fra ore preventivate\textsubscript{G} e ore consuntivate, senza ricalibrazioni, secondo il criterio adottato dallo Sprint\textsubscript{G} \#8. Alla chiusura quel criterio esaurisce la propria funzione diagnostica, poiché non esistono periodi successivi in cui assorbire le poste residue: la dotazione di ciascuna coppia risorsa-ruolo è stata quindi allineata all'impiego effettivo, recependo nel budget le 9 ore eccedenti dell'Analista\textsubscript{G} e l'ora dell'Amministratore\textsubscript{G} e stornando le 6 ore non utilizzate del Programmatore\textsubscript{G}, le 2 del Progettista\textsubscript{G} e quella di Responsabile\textsubscript{G} e Verificatore\textsubscript{G}.

Il prospetto conclusivo presenta pertanto due caratteristiche:
\begin{itemize}
    \item \textbf{ogni voce è nulla}, sia per coppia risorsa-ruolo sia per totale di riga e di colonna: nessun membro chiude in debito o in credito e nessun ruolo\textsubscript{G} conserva dotazione inutilizzata. È l'esito congiunto del vincolo sul totale individuale introdotto nel preventivo\textsubscript{G} dello Sprint\textsubscript{G} \#11, del criterio di ripartizione per residuo adottato nel periodo conclusivo e della rettifica del budget;

    \item \textbf{il costo coincide con il consuntivo\textsubscript{G}}: 12.395,00 €, con scostamento\textsubscript{G} nullo rispetto al budget rettificato e un incremento di 60,00 € rispetto alla valorizzazione precedente la rettifica, imputabile al minor impiego dell'Analista\textsubscript{G} rispetto alla ripartizione ipotizzata all'avvio del progetto e al maggior impiego di Programmatore\textsubscript{G} e Progettista\textsubscript{G}.
\end{itemize}
Il preventivo a finire aggiornato è riportato nella \hyperref[tab:preventivo-finire]{Sezione \S5.1}.
