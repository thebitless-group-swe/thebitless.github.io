...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{|c|c|c|c|c|X|}
        ...
        \hline
        1.2.0 & 2026-07-21 & D. Facco & A. Menegaldo & - & Pianificazione, preventivo e consuntivo Sprint \#8, ricalibrazione del preventivo a finire e aggiornamento dell'analisi dei rischi (RO-6, RO-8) \\
        \hline
        1.0.0 & 2026-07-07 & - & - & D. Facco & Approvazione della revisione del documento per l'ingresso nella baseline di RTB, sulla base del lavoro di stesura e verifica tracciato nelle righe sottostanti \\
        \hline
        0.15.0 & 2026-07-06 & S. Vendramin & A. Marini & - & Revisione stima dei costi (riduzione ore Progettista nel preventivo a finire) e stima temporale \\
        \hline
...
\textbf{Ultimo aggiornamento: 2026-07-20}

Di seguito è riportato il preventivo ``a finire'', ovvero la stima delle ore e dei costi ancora necessari al completamento del progetto, soggetto a miglioramento continuo in base alle considerazioni del consuntivo di periodo. Al termine dello Sprint\textsubscript{G} \#8 risultano consuntivate complessivamente 410 ore delle 623 preventivate, con 213 ore residue.

La ripartizione è stata ricalibrata a valle dello Sprint\textsubscript{G} \#8: il monte ore del ruolo Analista\textsubscript{G}, risultato negativo a seguito dello sfondamento registrato nella revisione dei requisiti\textsubscript{G} non funzionali, è stato riportato in positivo attingendo alle ore del ruolo Progettista\textsubscript{G}, la cui attività residua si è ridotta grazie all'analisi dei design pattern\textsubscript{G} e dell'architettura\textsubscript{G} generale già svolta. Trattandosi di ruoli con identico costo orario, l'operazione lascia invariato il valore economico complessivo delle ore residue e il budget totale del progetto.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|c|c|c|c|c|c|c|}
        ...
        \hline
        L. Battistella & 2 & 1 & 1 & 5 & 15 & 13 & 37 \\
        \hline
        E. De Piccoli & 1 & 1 & 1 & 5 & 12 & 10 & 30 \\
        \hline
        D. Facco & 2 & 1 & 1 & 4 & 12 & 11 & 31 \\
        \hline
        A. Marini & 1 & 0 & 1 & 4 & 10 & 10 & 26 \\
        \hline
        A. Menegaldo & 2 & 1 & 2 & 5 & 16 & 15 & 41 \\
        \hline
        S. Vendramin & 1 & 0 & 1 & 4 & 9 & 8 & 23 \\
        \hline
        S. Zecchinato & 1 & 1 & 1 & 3 & 8 & 11 & 25 \\
        \hline
        \rowcolor[HTML]{EFEFEF}
        \textbf{Totale per ruolo} & \textbf{10} & \textbf{5} & \textbf{8} & \textbf{30} & \textbf{82} & \textbf{78} & \textbf{213} \\
        \hline
        \rowcolor[HTML]{EFEFEF}
        \textbf{Costo totale (in €)} & \textbf{300,00} & \textbf{100,00} & \textbf{200,00} & \textbf{750,00} & \textbf{1.230,00} & \textbf{1.170,00} & \textbf{3.750,00} \\
        \hline
    \end{tabularx}
    \caption{Preventivo a finire al termine dello Sprint \#8}
\end{table}
...
Rispetto agli sprint\textsubscript{G} precedenti il gruppo ha scelto di preventivare\textsubscript{G} un monte ore sensibilmente più elevato. La decisione, assunta durante la riunione di apertura dello sprint\textsubscript{G} del 2026-07-07, nasce dalla constatazione che gli sprint\textsubscript{G} \#6 e \#7 avevano lasciato emergere alcuni ``tempi morti'' legati all'attesa dei riscontri esterni: con l'avvio della progettazione\textsubscript{G} di dettaglio e della documentazione di PB\textsubscript{G} il carico di lavoro effettivo cresce in modo significativo e una pianificazione\textsubscript{G} più densa consente di sfruttare pienamente il tempo a disposizione.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \hline
        L. Battistella & - & - & - & - & - & 10 & 10 \\ \hline
        E. De Piccoli & - & - & - & 12 & - & - & 12 \\ \hline
        D. Facco & - & - & 12 & - & - & - & 12 \\ \hline
        A. Marini & 10 & - & - & - & - & - & 10 \\ \hline
        A. Menegaldo & - & 8 & - & - & - & - & 8 \\ \hline
        S. Vendramin & - & - & - & 12 & - & - & 12 \\ \hline
        S. Zecchinato & - & - & 12 & - & - & - & 12 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{10} & \textbf{8} & \textbf{24} & \textbf{24} & \textbf{-} & \textbf{10} & \textbf{76} \\
        \hline
    \end{tabular}
...
\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90:\r) arc[start angle=90,end angle=42.6,radius=\r] -- cycle;

\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (42.6:\r) arc[start angle=42.6,end angle=4.7,radius=\r] -- cycle;

\path[fill=colAn, draw=white, line width=1.5pt]
(0,0) -- (4.7:\r) arc[start angle=4.7,end angle=-109,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (-109:\r) arc[start angle=-109,end angle=-222.6,radius=\r] -- cycle;

\path[fill=colVer, draw=white, line width=1.5pt]
(0,0) -- (-222.6:\r) arc[start angle=-222.6,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\footnotesize\bfseries] at (66.3:2.05) {13,2\%};
\node[font=\footnotesize\bfseries] at (23.6:2.15) {10,5\%};
\node[font=\small\bfseries] at (-52.1:1.85) {31,6\%};
\node[font=\small\bfseries] at (-165.8:1.85) {31,6\%};
\node[font=\footnotesize\bfseries] at (113.7:2.05) {13,2\%};

% Etichette esterne
% Responsabile (alto destra)
\fill[lineGray] (0.7,1.55) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.7,1.55) -- (5.5,2.6);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,2.67) {Responsabile};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,2.45) {10 ore};

% Amministratore (destra)
\fill[lineGray] (1.56,0.68) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.56,0.68) -- (5.5,0.7);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,0.77) {Amministratore};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,0.55) {8 ore};

% Analista (basso destra)
\fill[lineGray] (1.05,-1.34) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.05,-1.34) -- (5.5,-1.4);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,-1.33) {Analista};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,-1.55) {24 ore};

% Progettista (basso sinistra)
\fill[lineGray] (-1.65,-0.41) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.65,-0.41) -- (-5.5,-1.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,-1.33) {Progettista};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,-1.55) {24 ore};

% Verificatore (alto sinistra)
\fill[lineGray] (-0.68,1.56) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.68,1.56) -- (-5.5,1.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,1.47) {Verificatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,1.25) {10 ore};
...
Il preventivo dello Sprint\textsubscript{G} \#8 si discosta in modo evidente da quelli dei periodi precedenti: a fronte di una media di circa 44 ore preventivate per sprint\textsubscript{G} negli Sprint\textsubscript{G} dal \#1 al \#7, il gruppo ha stimato per questo periodo 76 ore produttive. L'incremento è motivato dalla concentrazione, in un unico sprint\textsubscript{G}, di tre attività onerose e in larga parte parallele: il refactoring\textsubscript{G} dei requisiti\textsubscript{G} non funzionali richiesto dal prof. Cardin, la preparazione e lo svolgimento della seconda parte della presentazione RTB\textsubscript{G} e l'avvio contestuale della progettazione\textsubscript{G} di dettaglio dell'MVP\textsubscript{G} e dell'analisi dei design pattern\textsubscript{G}. Il carico è distribuito in modo simmetrico tra le due coppie Analisti\textsubscript{G} e Progettisti\textsubscript{G}, che assorbono complessivamente il 63,2\% delle ore preventivate.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \textbf{Ruolo} & \textbf{Ore per ruolo} & \textbf{Costo (in €)} \\
        \hline
        Responsabile di progetto & 10 & 300,00 \\ \hline
        Amministratore & 8 & 160,00 \\ \hline
        Analista & 24 & 600,00 \\ \hline
        ...
        Verificatore & 10 & 150,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{76} & \textbf{1.810,00} \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \hline
        L. Battistella & - & - & - & - & - & 10 & 10 \\ \hline
        E. De Piccoli & - & - & - & 15 & - & - & 15 \\ \hline
        D. Facco & - & - & 15 & - & - & - & 15 \\ \hline
        A. Marini & 11 & - & - & - & - & - & 11 \\ \hline
        A. Menegaldo & - & 9 & - & - & - & - & 9 \\ \hline
        S. Vendramin & - & - & - & 14 & - & - & 14 \\ \hline
        S. Zecchinato & - & - & 14 & - & - & - & 14 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{11} & \textbf{9} & \textbf{29} & \textbf{29} & \textbf{-} & \textbf{10} & \textbf{88} \\
        \hline
    \end{tabular}
...
\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (45:\r) arc[start angle=45,end angle=8.2,radius=\r] -- cycle;

\path[fill=colAn, draw=white, line width=1.5pt]
(0,0) -- (8.2:\r) arc[start angle=8.2,end angle=-110.5,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (-110.5:\r) arc[start angle=-110.5,end angle=-229.1,radius=\r] -- cycle;

\path[fill=colVer, draw=white, line width=1.5pt]
(0,0) -- (-229.1:\r) arc[start angle=-229.1,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\footnotesize\bfseries] at (67.5:2.05) {12,5\%};
\node[font=\footnotesize\bfseries] at (26.6:2.15) {10,2\%};
\node[font=\small\bfseries] at (-51.1:1.85) {33,0\%};
\node[font=\small\bfseries] at (-169.8:1.85) {33,0\%};
\node[font=\footnotesize\bfseries] at (110.5:2.05) {11,4\%};

% Etichette esterne
% Responsabile (alto destra)
\fill[lineGray] (0.65,1.57) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (0.65,1.57) -- (5.5,2.6);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,2.67) {Responsabile};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,2.45) {11 ore};

% Amministratore (destra)
\fill[lineGray] (1.52,0.76) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.52,0.76) -- (5.5,0.7);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,0.77) {Amministratore};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,0.55) {9 ore};

% Analista (basso destra)
\fill[lineGray] (1.07,-1.32) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.07,-1.32) -- (5.5,-1.4);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,-1.33) {Analista};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,-1.55) {29 ore};

% Progettista (basso sinistra)
\fill[lineGray] (-1.67,-0.30) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.67,-0.30) -- (-5.5,-1.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,-1.33) {Progettista};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,-1.55) {29 ore};

% Verificatore (alto sinistra)
\fill[lineGray] (-0.60,1.59) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.60,1.59) -- (-5.5,1.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,1.47) {Verificatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,1.25) {10 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Responsabile di progetto & 11 & -1 & 330,00 & -30,00 \\ \hline
        Amministratore & 9 & -1 & 180,00 & -20,00 \\ \hline
        Analista & 29 & -5 & 725,00 & -125,00 \\ \hline
        Progettista & 29 & -5 & 725,00 & -125,00 \\ \hline
        Programmatore & 0 & 0 & 0,00 & 0,00 \\ \hline
        Verificatore & 10 & 0 & 150,00 & 0,00 \\ \hline

        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{88} & \textbf{-12} & \textbf{2.110,00} & \textbf{-300,00} \\ \hline

        Sprint pregressi & 322 & / & 6.475,00 & / \\ \hline
        Restante & 213 & / & 3.750,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 2 & 3 & 13 & 15 & 2 & 37 \\ \hline
        E. De Piccoli & 4 & 4 & 1 & -5 & 15 & 11 & 30 \\ \hline
        D. Facco & 4 & 1 & -8 & 12 & 4 & 18 & 31 \\ \hline
        A. Marini & -8 & 1 & -2 & 9 & 11 & 15 & 26 \\ \hline
        A. Menegaldo & 5 & -6 & 1 & 13 & 13 & 15 & 41 \\ \hline
        S. Vendramin & 1 & 1 & -4 & 4 & 14 & 7 & 23 \\ \hline
        S. Zecchinato & 2 & 0 & -12 & 14 & 12 & 9 & 25 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{10} & \textbf{3} & \textbf{-21} & \textbf{60} & \textbf{84} & \textbf{77} & \textbf{213} \\
        \hline
    \end{tabular}
...
Nel corso dell'ottavo sprint\textsubscript{G} il team ha operato su tre fronti paralleli: il recepimento dei rilievi del prof. Riccardo Cardin, la seconda parte della presentazione RTB\textsubscript{G} con il prof. Tullio Vardanega e l'avvio della fase di Product Baseline\textsubscript{G}. Le attività effettivamente svolte sono state:
\begin{itemize}
    \item sistemazione degli errori e dei requisiti\textsubscript{G} segnalati dal prof. Riccardo Cardin nell'\textit{Analisi dei Requisiti}, con riscrittura dei requisiti\textsubscript{G} non funzionali in forma misurabile e verificabile\textsubscript{G} e conseguente aggiornamento delle tabelle di tracciamento;
...
Sul piano dei consumi, a fronte di 76 ore preventivate ne sono state consuntivate 88, con uno scostamento\textsubscript{G} di 12 ore (+15,8\%) e un costo di 2.110,00 € contro i 1.810,00 € previsti, pari a un maggior onere di 300,00 €. Lo sfondamento si concentra interamente sui ruoli di Analista\textsubscript{G} (29 ore contro 24) e Progettista\textsubscript{G} (29 ore contro 24), mentre Responsabile\textsubscript{G} e Amministratore\textsubscript{G} registrano uno scostamento\textsubscript{G} contenuto di un'ora ciascuno e il Verificatore\textsubscript{G} chiude in linea con il preventivo. Con questo periodo il monte ore complessivamente consuntivato sale a 410 ore delle 623 preventivate, per un valore di 8.585,00 €, lasciando 213 ore residue pari a 3.750,00 €.

Va sottolineato che si tratta comunque dello sprint\textsubscript{G} più oneroso dall'avvio del progetto: le 88 ore consuntivate sono circa il doppio della media dei periodi precedenti, pari a 46 ore per sprint\textsubscript{G} negli Sprint\textsubscript{G} dal \#1 al \#7. L'incremento era in buona parte atteso e voluto, poiché deliberato in sede di pianificazione\textsubscript{G} per assorbire i ``tempi morti'' dei periodi precedenti; lo scostamento\textsubscript{G} di 12 ore rappresenta invece la quota non prevista, analizzata nel paragrafo seguente.

\subsubsection{Retrospettiva}
Gli obiettivi dello sprint\textsubscript{G} sono stati raggiunti nella loro totalità: tutte le attività pianificate sono state portate a termine entro la finestra dei quattordici giorni e nessun elemento è stato rimandato allo sprint\textsubscript{G} successivo. Il grado di raggiungimento è quindi da considerarsi pieno sul piano dei risultati, ma parziale sul piano dell'efficienza, dato lo scostamento\textsubscript{G} orario registrato. Dal confronto interno sono emerse le seguenti ragioni presunte delle discrepanze:
\begin{itemize}
    \item \textbf{Complessità imprevista nell'analisi dei design pattern\textsubscript{G}.} I Progettisti\textsubscript{G} avevano stimato l'attività come una selezione fra alternative già note, mentre si è rivelata un lavoro di valutazione comparativa ben più oneroso: la scelta dei pattern\textsubscript{G} per la mediazione verso il servizio LLM\textsubscript{G} e per la gestione dello stato dell'editor ha richiesto di scartare due ipotesi iniziali dopo averle già istruite, e la ricaduta sull'architettura\textsubscript{G} generale ha imposto di rivedere la suddivisione in livelli prima di poterla documentare nella \textit{Specifica Tecnica}. A questo si aggiunge la scarsa familiarità pregressa del gruppo con la formalizzazione architetturale, mai affrontata prima in un contesto di progetto reale. Le 5 ore eccedenti sul ruolo Progettista\textsubscript{G} sono interamente riconducibili a questa attività.
    \item \textbf{Tempi più lunghi del previsto per il refactoring\textsubscript{G} dei requisiti\textsubscript{G}.} La riscrittura dei requisiti\textsubscript{G} non funzionali segnalati dal prof. Cardin non si è esaurita nella riformulazione testuale: rendere ciascun requisito\textsubscript{G} misurabile ha richiesto di individuare metriche e soglie oggettive e, in diversi casi, di scomporre un singolo requisito\textsubscript{G} generico in più requisiti\textsubscript{G} distinti. L'operazione ha innescato un effetto a catena sulle tabelle di tracciamento verso i casi d'uso\textsubscript{G} e sui riferimenti presenti nel \textit{Piano di Qualifica}, che gli Analisti\textsubscript{G} non avevano considerato in sede di stima. Le 5 ore eccedenti sul ruolo Analista\textsubscript{G} derivano da questo effetto propagativo.
    \item \textbf{Colli di bottiglia organizzativi attorno all'incontro con il prof. Vardanega.} La concentrazione della presentazione RTB\textsubscript{G} nella prima parte del periodo ha reso necessari alcuni momenti di allineamento collettivo aggiuntivi rispetto a quelli pianificati, durante i quali parte del gruppo è rimasta in attesa senza poter avanzare sui propri task\textsubscript{G}. La fase di PB\textsubscript{G} ha inoltre potuto essere avviata concretamente solo a valle dell'esito dell'incontro, comprimendo le attività di progettazione\textsubscript{G} nella seconda metà dello sprint\textsubscript{G} e riducendo il margine disponibile per assorbire gli imprevisti. Il maggior carico di coordinamento spiega l'ora eccedente sul Responsabile\textsubscript{G} e sull'Amministratore\textsubscript{G}.
\end{itemize}
Sul piano positivo, il gruppo rileva che l'aumento del monte ore preventivato ha effettivamente eliminato i ``tempi morti'' osservati negli Sprint\textsubscript{G} \#6 e \#7: la scelta di densificare la pianificazione\textsubscript{G} si è dimostrata corretta nella direzione, se non ancora nella misura. Il clima di lavoro è rimasto collaborativo e la ripartizione su due Analisti\textsubscript{G} e due Progettisti\textsubscript{G} ha consentito la revisione incrociata che il gruppo si era prefissato.

\subsubsection{Misure correttive}
A fronte delle criticità rilevate, il gruppo ha definito le seguenti azioni correttive:
\begin{itemize}
    \item \textbf{Istruttoria preliminare delle scelte architetturali.} Prima di stimare le attività di progettazione\textsubscript{G}, i Progettisti\textsubscript{G} dedicano una sessione dedicata alla ricognizione delle alternative disponibili, producendo un elenco motivato dei pattern\textsubscript{G} candidati. La stima viene formulata solo dopo tale ricognizione, così da non scontare a posteriori il costo delle ipotesi scartate.
    \item \textbf{Stima estesa agli effetti propagativi.} Ogni attività che modifica requisiti\textsubscript{G}, casi d'uso\textsubscript{G} o loro tracciamenti viene stimata includendo esplicitamente l'aggiornamento dei documenti collegati, in particolare il \textit{Piano di Qualifica}. La verifica\textsubscript{G} di coerenza fra documenti diventa parte della definizione di completamento del task\textsubscript{G}.
    \item \textbf{Disaccoppiamento delle attività dai riscontri esterni.} Il Responsabile\textsubscript{G} pianifica per ogni periodo un insieme di attività indipendenti dagli incontri con la committenza\textsubscript{G} e dai riscontri esterni, da assegnare ai membri che si trovino temporaneamente bloccati, riducendo i tempi di attesa collettiva.
    \item \textbf{Riequilibrio del budget del ruolo Analista\textsubscript{G}.} Il monte ore residuo dell'Analista\textsubscript{G} risulta negativo (-21 ore) a seguito dello sfondamento: il gruppo interviene sul preventivo a finire riportandolo in positivo, come descritto nel paragrafo dedicato.
\end{itemize}

\paragraph{Aggiornamento dell'analisi dei rischi (\hyperref[tab:gestione-rischi]{Sezione \S2})}
Lo Sprint\textsubscript{G} \#8 ha visto la manifestazione concreta di due rischi\textsubscript{G} già censiti, la cui valutazione viene aggiornata di conseguenza nella \hyperref[tab:gestione-rischi]{Sezione \S2} e nella relativa tabella riassuntiva:
\begin{itemize}
    \item \textbf{RO-6 -- Errori di pianificazione\textsubscript{G}:} la probabilità passa da \textit{Bassa} a \textit{Media}. Il rischio\textsubscript{G} si è manifestato nella mancata considerazione delle dipendenze fra la revisione dei requisiti\textsubscript{G} e i documenti da essa derivati, e nella compressione delle attività di progettazione\textsubscript{G} nella seconda metà del periodo. Alle contromisure già previste viene aggiunta la pianificazione\textsubscript{G} di attività indipendenti dai riscontri esterni.
    \item \textbf{RO-8 -- Errata stima delle attività:} la probabilità passa da \textit{Media} ad \textit{Alta}. La sottostima si è verificata simultaneamente sui ruoli Analista\textsubscript{G} e Progettista\textsubscript{G} e riguarda attività, quali la definizione dell'architettura\textsubscript{G} e la formalizzazione dei requisiti\textsubscript{G} non funzionali, che il gruppo affronta per la prima volta e per le quali non dispone ancora di dati storici affidabili. Alle contromisure viene aggiunta l'istruttoria preliminare delle scelte architetturali prima della formulazione delle stime.
\end{itemize}
Il rischio\textsubscript{G} RO-4 (\textit{Risorse disponibili ma non impiegate}) non ha invece prodotto effetti apprezzabili: l'incremento del monte ore preventivato ha eliminato i periodi di inattività riscontrati negli sprint\textsubscript{G} precedenti e la sua valutazione resta invariata.

\subsubsection{Miglioramento della pianificazione futura}
Nel breve termine, ossia a partire dallo Sprint\textsubscript{G} \#9, le misure adottate incidono su tre aspetti della gestione del lavoro. In primo luogo il monte ore preventivato per periodo resta sui livelli raggiunti in questo sprint\textsubscript{G}: il ritmo di 80-90 ore effettive si è dimostrato sostenibile e necessario per la fase di Product Baseline\textsubscript{G}, che concentra progettazione\textsubscript{G}, codifica\textsubscript{G} e stesura documentale. In secondo luogo la composizione dei ruoli si sposta verso l'implementazione\textsubscript{G}: il gruppo reintroduce due Programmatori\textsubscript{G}, mantenendo due Progettisti\textsubscript{G} dedicati alla progettazione\textsubscript{G} di dettaglio e alla definizione dei pattern\textsubscript{G} architetturali, così da fornire ai Programmatori\textsubscript{G} una base implementabile senza interrompere il flusso di lavoro. In terzo luogo la stesura della \textit{Specifica Tecnica} viene distribuita lungo tutta la fase anziché concentrata al termine, procedendo di pari passo con le decisioni progettuali che documenta.

Nel lungo termine il gruppo adotta un criterio di stima più prudente per le attività prive di precedenti storici: a queste viene applicato un margine esplicito, in luogo della stima puntuale usata finora, riconoscendo che l'esperienza maturata sugli sprint\textsubscript{G} di documentazione non è trasferibile alle attività di progettazione\textsubscript{G} e codifica\textsubscript{G}. Il confronto sistematico fra preventivo\textsubscript{G} e consuntivo\textsubscript{G} per ruolo, e non solo sul totale di periodo, diventa parte stabile della retrospettiva\textsubscript{G}, così da individuare precocemente i ruoli in sofferenza anziché rilevarne lo sfondamento a budget esaurito. Il gruppo mantiene inoltre un margine di riserva sul monte ore complessivo per assorbire gli imprevisti della fase finale, evitando di dover ricorrere a rinegoziazioni del budget in prossimità delle scadenze.

\subsubsection{Preventivo a finire (\hyperref[tab:preventivo-finire]{Sezione \S5.1})}
Al termine dello Sprint\textsubscript{G} \#8 risultano consuntivate complessivamente 410 ore delle 623 preventivate, con 213 ore residue per un valore di 3.750,00 €. Il monte ore complessivo del progetto resta confermato a 623 ore e il budget totale a 12.335,00 €: la ricalibrazione non incrementa il costo del progetto, ma ne ridistribuisce le ore residue fra i ruoli, in quanto la ripartizione emersa dai consuntivi non è più coerente con le attività ancora da svolgere.

La revisione interviene su tre voci:
\begin{itemize}
    \item il ruolo \textbf{Analista\textsubscript{G}} passa da -21 a 8 ore residue. Il valore negativo, prodotto dallo sfondamento di questo sprint\textsubscript{G} e dei precedenti, non è sostenibile: la fase di PB\textsubscript{G} richiede ancora interventi di manutenzione\textsubscript{G} sui requisiti\textsubscript{G} e sui tracciamenti, che devono disporre di un budget effettivo;
    \item il ruolo \textbf{Progettista\textsubscript{G}} passa da 60 a 30 ore residue. L'analisi dei design pattern\textsubscript{G} e dell'architettura\textsubscript{G} generale svolta in questo sprint\textsubscript{G}, pur essendo costata più del previsto, ha anticipato una porzione consistente del lavoro progettuale residuo: le decisioni strutturali sono ormai assunte e ciò che resta è prevalentemente progettazione\textsubscript{G} di dettaglio incrementale;
    \item i ruoli \textbf{Programmatore\textsubscript{G}} e \textbf{Verificatore\textsubscript{G}} vengono ritoccati marginalmente, rispettivamente a 82 e 78 ore residue, mentre l'\textbf{Amministratore\textsubscript{G}} risale a 5 ore per coprire la gestione dei rilasci prevista nella fase conclusiva.
\end{itemize}
La ridistribuzione è stata costruita in modo da lasciare invariato il valore economico complessivo delle ore residue: le 30 ore sottratte al Progettista\textsubscript{G} finanziano il riequilibrio dell'Analista\textsubscript{G}, avendo i due ruoli il medesimo costo orario di 25,00 €. Il preventivo a finire aggiornato è riportato nella \hyperref[tab:preventivo-finire]{Sezione \S5.1}.
