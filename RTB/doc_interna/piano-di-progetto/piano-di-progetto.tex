...
\hyperref{sec:analisi-rischi}{Analisi e Gestione dei Rischi}{}{}
...
In base alle inefficienze rilevate in questa iterazione iniziale, la pianificazione per i prossimi cicli subirà modifiche strategiche importanti. Poiché l'apprendimento degli strumenti ha parzialmente sottratto tempo alla formalizzazione dei requisiti, il team si prefigge di ridefinire in maniera incrementale l'assegnazione delle attività. Per lo Sprint 2 verrà data assoluta priorità al superamento delle ambiguità documentali riscontrate e all'approfondimento condiviso dei casi d'uso\textsubscript{G}, garantendo una To-Do List molto più atomica ed esplicita così da prevenire ulteriori stalli informativi.

\paragraph{Preventivo a finire}

La tabella seguente riporta il riepilogo aggiornato delle ore e dei costi previsti a finire rispetto al piano iniziale, calcolato al termine dello Sprint 1.

\begin{table}[h]
\centering
\begin{tabular}{|l|c|c|c|c|c|}
\hline
\textbf{Ruolo} & \textbf{Ore Prev.} & \textbf{Scost.} & \textbf{EAC (Ore)} & \textbf{EAC (Costo)} & \textbf{Varianza} \\ \hline
Responsabile & 40 & 0 & 40 & 1.200 € & 0 € \\ \hline
Amministratore & 50 & 0 & 50 & 1.000 € & 0 € \\ \hline
Analista & 124 & +4 & 128 & 3.200 € & -100 € \\ \hline
Progettista & 150 & 0 & 150 & 3.750 € & 0 € \\ \hline
Programmatore & 180 & 0 & 180 & 2.700 € & 0 € \\ \hline
Verificatore & 100 & 0 & 100 & 1.110 € & 0 € \\ \hline
\textbf{Totale} & \textbf{644} & \textbf{+4} & \textbf{648} & \textbf{12.960 €} & \textbf{-100 €} \\ \hline
\end{tabular}
\caption{Proiezione EAC e Varianza al termine dello Sprint 1}
\end{table}

\paragraph{Gestione dei rischi}
Nel corso del primo sprint\textsubscript{G}, il team ha riscontrato il concreto affioramento di dinamiche organizzative critiche legate alla fase d'avvio del progetto. L'analisi sul campo ha dimostrato la parziale inefficacia delle contromisure teoriche, spingendo il gruppo a introdurre immediati raffinamenti metodologici per i periodi futuri.
...
\paragraph{Preventivo a finire}
L'andamento economico e orario complessivo mostra un lieve scostamento localizzato sul carico di verifica, ampiamente bilanciato dal risparmio di ore nel ruolo di Responsabile. Le risorse orarie residue, tracciate nel computo complessivo, verranno ridistribuite in maniera dinamica e flessibile per assorbire l'imminente carico documentale e supportare l'avvio della progettazione UX/UI\textsubscript{G} senza intaccare i vincoli di budget economico e le stime di spesa definite inizialmente nel Piano di Progetto.

La tabella seguente riporta il riepilogo aggiornato delle ore e dei costi previsti a finire, considerando l'avanzamento reale delle attività al termine dello Sprint 2.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|}
        \hline
        \rowcolor{bluBitless!15}
        \textbf{Ruolo} & \textbf{Ore Prev. Iniz.} & \textbf{Scost.} & \textbf{EAC (Ore)} & \textbf{EAC (Costo)} & \textbf{Varianza} \\ \hline
        Responsabile & 48 & +1 & 49 & 1.470 EUR & -30 EUR \\ \hline
        Amministratore & 60 & 0 & 60 & 1.200 EUR & 0 EUR \\ \hline
        Analista & 62 & +4 & 66 & 1.650 EUR & -100 EUR \\ \hline
        Progettista & 156 & 0 & 156 & 3.900 EUR & 0 EUR \\ \hline
        Programmatore & 158 & 0 & 158 & 2.370 EUR & 0 EUR \\ \hline
        Verificatore & 160 & -4 & 156 & 2.340 EUR & +60 EUR \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{644} & \textbf{+1} & \textbf{645} & \textbf{12.930 EUR} & \textbf{-70 EUR} \\ \hline
    \end{tabular}
    \caption{\textit{Aggiornamento del Preventivo a Finire e Varianza al termine dello Sprint 2}}
\end{table}
...
\paragraph{Pianificazione futura}
Alla luce delle analisi a posteriori emerse durante la retrospettiva\textsubscript{G}, il gruppo ha deciso di riadattare la pianificazione per i prossimi periodi. Avendo consolidato l'Analisi dei Requisiti, il focus principale si sposterà dalle attività documentali verso la specifica architetturale e la configurazione dell'ambiente di sviluppo. 
In particolare, la pianificazione del quarto sprint\textsubscript{G} vedrà l'introduzione operativa del ruolo di Programmatore, una figura che diventerà centrale nei prossimi periodi. Il Programmatore lavorerà a stretto contatto con il Progettista, così da tradurre le scelte di design e i mock-up\textsubscript{G} in codice reale per il \textit{Proof of Concept} (PoC). Poiché lo studio approfondito delle tecnologie è stato posticipato a causa del carico documentale di questo sprint, il prossimo periodo includerà una forte componente di auto-formazione interna. L'obiettivo è permettere a tutti i membri di allinearsi sulle librerie e sui framework scelti per il prodotto \textit{Second Brain} prima di iniziare la codifica vera e propria.
\paragraph{Preventivo a finire}
Per quanto riguarda la gestione del budget e delle risorse orarie, il team ha effettuato un'analisi dettagliata sulle ore ancora disponibili per ciascun ruolo. In questo sprint\textsubscript{G} non sono state risparmiate ore, ma al contrario si è registrato un sovraccosto di 3 ore nel ruolo di Analista per far fronte alle incomprensioni comunicative e alle correzioni dell'Analisi dei Requisiti. Di conseguenza, il monte ore rimanente per l'Analista nei prossimi periodi è stato volutamente ridotto e rimodulato. 

Dal momento che la struttura principale dell'Analisi dei Requisiti è ormai stabile, per i prossimi sprint ci si limiterà ad attività di rifinitura formale in vista della milestone\textsubscript{G} della RTB\textsubscript{G}. Questa riduzione ci permetterà di concentrare le forze restanti sui ruoli tecnici di Progettista e Programmatore, che richiederanno un impegno maggiore con l'avvio del Proof of Concept.
