...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        S. Zecchinato & - & - & - & - & - & 7 & 7 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{4} & \textbf{7} & \textbf{10} & \textbf{16} & \textbf{-} & \textbf{13} & \textbf{50} \\
        \hline
    \end{tabular}
...
\path[fill=colAn, draw=white, line width=1.5pt]
(0,0) -- (10.8:\r) arc[start angle=10.8,end angle=-61.2,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (-61.2:\r) arc[start angle=-61.2,end angle=-176.4,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-176.4:\r) arc[start angle=-176.4,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (75:1.65) {8,0\%};
\node[font=\small\bfseries] at (36:1.75) {14,0\%};
\node[font=\small\bfseries] at (-25:1.75) {20,0\%};
\node[font=\small\bfseries] at (-118:1.75) {32,0\%};
\node[font=\small\bfseries] at (136:1.75) {26,0\%};
...
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.45,-2.60) {16 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        Progettista & 16 & 400,00 \\ \hline
        Programmatore & 0 & 0,00 \\ \hline
        Verificatore & 13 & 195,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{50} & \textbf{1.105,00} \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        D. Facco & - & - & - & 10 & - & - & 10 \\ \hline
        A. Marini & 4 & - & 3 & - & - & - & 7 \\ \hline
        A. Menegaldo & - & - & 1 & 8 & - & - & 9 \\ \hline
        S. Vendramin & - & - & 1 & - & - & 6 & 7 \\ \hline
        S. Zecchinato & - & - & - & - & - & 7 & 7 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{4} & \textbf{7} & \textbf{13} & \textbf{18} & \textbf{-} & \textbf{13} & \textbf{55} \\
        \hline
    \end{tabular}
...
% Settori
\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90:\r) arc[start angle=90,end angle=63.8,radius=\r] -- cycle;

\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (63.8:\r) arc[start angle=63.8,end angle=18.0,radius=\r] -- cycle;

\path[fill=colAn, draw=white, line width=1.5pt]
(0,0) -- (18.0:\r) arc[start angle=18.0,end angle=-67.1,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (-67.1:\r) arc[start angle=-67.1,end angle=-184.9,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-184.9:\r) arc[start angle=-184.9,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (77:1.65) {7,3\%};
\node[font=\small\bfseries] at (41:1.75) {12,7\%};
\node[font=\small\bfseries] at (-25:1.75) {23,6\%};
\node[font=\small\bfseries] at (-126:1.75) {32,7\%};
\node[font=\small\bfseries] at (-227:1.75) {23,7\%};
...
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.45,-2.65) {18 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Progettista & 18 & -2 & 450,00 & -50,00 \\ \hline
        Programmatore & 0 & 0 & 0,00 & 0,00 \\ \hline
        Verificatore & 13 & 0 & 195,00 & 0,00 \\ \hline

        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{55} & \textbf{-5} & \textbf{1.230,00} & \textbf{-125,00} \\ \hline

        Sprint pregressi & 90 & / & 2.010,00 & / \\ \hline
        Restante & 499 & / & 9.610,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        D. Facco & 7 & 8 & 3 & 12 & 23 & 16 & 69 \\ \hline
        A. Marini & 3 & 1 & 0 & 22 & 23 & 23 & 72 \\ \hline
        A. Menegaldo & 7 & 8 & 2 & 15 & 22 & 15 & 69 \\ \hline
        S. Vendramin & 0 & 9 & 0 & 22 & 24 & 16 & 71 \\ \hline
        S. Zecchinato & 6 & 9 & 0 & 23 & 22 & 13 & 73 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{32} & \textbf{41} & \textbf{7} & \textbf{138} & \textbf{158} & \textbf{123} & \textbf{499} \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        A. Menegaldo & 7 & 5 & 0 & 23 & 22 & 9 & 66 \\ \hline
        S. Vendramin & 0 & 9 & 0 & 16 & 15 & 22 & 62 \\ \hline
        S. Zecchinato & 2 & 9 & 0 & 23 & 19 & 14 & 67 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{28} & \textbf{31} & \textbf{5} & \textbf{125} & \textbf{146} & \textbf{116} & \textbf{451} \\
        \hline
    \end{tabular}
