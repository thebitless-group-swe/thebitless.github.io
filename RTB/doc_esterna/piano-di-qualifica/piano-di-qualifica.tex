...
\begin{longtable}{|c|p{4cm}|p{3cm}|p{3cm}|}
    ...
    MPD-PR$_G$ & Privacy$_G$ Risk & Nessun dato sensibile non necessario inviato & Minimizzazione completa dei dati inviati \\ \hline
...
Valutazione: 
\begin{itemize}
    \item \textbf{Valore accettabile CV:} $CV>0$, vincolo$_G$ \textit{violato} in uno sprint$_G$ su tr con scostamento lieve.
...
\begin{itemize}
    \item \textbf{Valore accettabile:} EAC$\leq 110\%$ budget$_G$, vincolo$_G$ \textit{rispettato}.
    \item \textbf{Valore ottimale:} EAC$\leq$ budget$_G$, vincolo$_G$ \textit{violato} in uno sprint$_G$ su tre.
\end{itemize}
\begin{figure}[H]
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $TCR = 100\%$, vincolo$_G$ \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $TS = 0\%$, vincolo$_G$ \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $MR \leq 5\%$, vincolo$_G$ \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $IR = 0\%$, vincolo$_G$ \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Valore accettabile:} $PMS \geq 80\%$, vincolo$_G$ \textit{non rispettato} nello sprint$_G$ 3.
\end{itemize}

\subsubsection{PB}
Valutazione:
\begin{itemize}
    \item \textbf{Valore accettabile:} $PMS \geq 80\%$, vincolo$_G$ \textit{rispettato}.
    \item \textbf{Valore ottimo:} $PMS = 100\%$, vincolo$_G$ \textit{non rispettato} nello sprint$_G$ 9.
\end{itemize}
