...
\begin{longtable}{|c|c|c|c|c|p{4cm}|}
    ...
    \hline
    \endhead
    0.1.1 & 2026-06-04 & L. Battistella & - & - & Aggiornamento test di sistema. \\ 
    \hline
...
\begin{longtable}{|p{1.8cm}|p{9cm}|p{2.5cm}|p{1.5cm}|}
    ...
    \hline
    TS-003 & Verificare che l'Utente possa tagliare una porzione di testo selezionata, rimuovendola dall'editor e memorizzandola negli appunti di sistema. & R-3-F-Ob & NI \\
    \hline
    TS-004 & Verificare che l'Utente possa copiare una porzione di testo selezionata negli appunti di sistema senza modificare il contenuto dell'editor. & R-4-F-Ob & NI \\
    \hline
    ...
    \hline
    TS-026 & Verificare che l'Utente possa analizzare criticamente il testo secondo la metodologia dei Sei Cappelli per Pensare. & R-33-F-Ob & NI \\
    \hline
    ...
    \hline
    TS-029 & Verificare che l'Utente possa salvare, scartare o rigenerare l'output prodotto dall'LLM$_G$. & R-40-F-Ob & NI \\
    \hline
    TS-030 & Verificare che il Sistema gestisca gli errori di comunicazione o risposta del servizio LLM$_G$, preservando il contenuto originale dell'editor. & R-42-F-Ob & NI \\
    \hline
    TS-031 & Verificare che il Sistema impedisca l'invio di richieste AI quando il testo fornito è insufficiente per un'elaborazione significativa. & R-43-F-Ob & NI \\
    \hline
    TS-032 & Verificare che l'Utente possa creare una nuova nota vuota nell'editor. & R-44-F-Ob & NI \\
    \hline
    TS-033 & Verificare che il Sistema gestisca eventuali errori durante la creazione di una nuova nota, informando l'Utente e preservando lo stato precedente. & R-46-F-Ob & NI \\
    \hline
    TS-034 & Verificare che l'Utente possa caricare una nota da file locale in formato .md o .txt. & R-47-F-Ob & NI \\
    \hline
    TS-035 & Verificare che il Sistema gestisca eventuali errori durante il caricamento di una nota, preservando la sessione di lavoro precedente. & R-49-F-Ob & NI \\
    \hline
    TS-036 & Verificare che l'Utente possa salvare una nota sul File System locale. & R-50-F-Ob & NI \\
    \hline
    TS-037 & Verificare che il Sistema gestisca eventuali errori durante il salvataggio di una nota, preservando l'integrità dei dati presenti nell'editor. & R-52-F-Ob & NI \\
    \hline
    TS-038 & Verificare che l'Utente possa eliminare una nota dal File System locale. & R-53-F-Ob & NI \\
    \hline
    TS-039 & Verificare che il Sistema gestisca eventuali errori durante l'eliminazione di una nota, evitando la perdita inconsistente dei dati. & R-55-F-Ob & NI \\
    \hline
    TS-040 & Verificare che l'Utente possa rinominare una nota locale. & R-56-F-Ob & NI \\
    \hline
    TS-041 & Verificare che il Sistema gestisca eventuali errori durante la rinominazione di una nota, mantenendo il titolo precedente. & R-58-F-Ob & NI \\
    \hline
    ...
    \hline
    TS-047 & Verificare che l'Utente possa inserire testo tramite dettatura vocale, se il browser supporta le Web Speech API. & R-26-F-De & NI \\
    \hline
    ...
    \hline
    TS-050 & Verificare che il Sistema mostri all'Utente un riepilogo del contesto prima dell'invio della richiesta all'LLM$_G$. & R-37-F-De & NI \\
    \hline
    ...
    \hline
    TS-065 & Verificare che il Sistema gestisca eventuali errori di autenticazione, mantenendo l'Utente disconnesso e mostrando un messaggio di errore. & R-65-F-Op & NI \\
    \hline
    TS-066 & Verificare che l'Utente non autenticato possa registrare un nuovo account. & R-66-F-Op & NI \\
    \hline
    TS-067 & Verificare che il Sistema impedisca la registrazione con uno username già presente nel database$_G$. & R-67-F-Op & NI \\
    \hline
    TS-068 & Verificare che il Sistema impedisca la registrazione se la password e la conferma password non coincidono. & R-68-F-Op & NI \\
    \hline
