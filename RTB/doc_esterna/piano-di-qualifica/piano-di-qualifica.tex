...
\newcommand{\dataversione}{2026-06-24}
...
\begin{longtable}{|c|c|c|c|c|p{4cm}|}
    ...
    \hline
    \endhead
    1.0.0 & 2026-06-24 & - & S. Vendramin & D. Facco & Approvazione$_G$ finale \\
    \hline
    0.5.0 & 2026-06-24 & S. Zecchinato & - & - & Aggiunge valutazione MPC-PMS e sistema$_G$ le altre \\
    \hline
...
\begin{itemize}
    \item \href{https://thebitless.live/RTB/doc_interna/norme-di-progetto/norme-di-progetto.pdf}{\textbf{Norme di Progetto v1.0.0}} \\ 
    ...
    \item \href{https://thebitless.live/RTB/doc_esterna/piano-di-progetto/piano-di-progetto.pdf}{\textbf{Piano di Progetto v1.0.0}} \\
    ...
    \item \href{https://thebitless.live/RTB/doc_esterna/analisi-dei-requisiti/analisi-dei-requisiti.pdf}{\textbf{Analisi dei Requisiti v1.0.0}} \\
    ...
    \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C6.pdf}{\textbf{Capitolato C6 -- Second Brain}} \\
...
\begin{itemize}
    \item \href{https://thebitless.live/RTB/doc_interna/glossario/glossario.pdf}{\textbf{Glossario v1.0.0}} \\
    ...
    \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Dispense/T07.pdf}{\textbf{Slide T07 -- Qualità del software}} \\
    Materiale didattico del corso di Ingegneria del Software. \\
    Ultimo accesso: 23 giugno 2026

    \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Dispense/T08.pdf}{\textbf{Slide T08 -- Qualità del software}} \\
    Materiale didattico del corso di Ingegneria del Software. \\
    Ultimo accesso: 23 giugno 2026
    ...
    Ultimo accesso: 08 giugno 2026

    \item \href{https://md-tool.com/it/markdown-guide}{\textbf{Documentazione Markdown}} \\
    ...
    \item \href{https://developers.openai.com/api/reference/overview}{\textbf{Documentazione API compatibili con OpenAI}} \\
...
Questo lo si può notare anche dall'accumulo di EV che, dallo sprint$_G$ 3, comincia ad essere maggiore dell'accumulo di PV, che riporta quindi un avanzamento del progetto di poco in anticipo rispetto a quanto pianificato. Valutazione:
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} EV$\geq PV$, vincolo$_G$ \textit{violato} in uno sprint$_G$ su cinque.
\end{itemize}
\begin{figure}[H]
...
\begin{itemize}
    ...
    \item \textbf{Sprint 4:} In questo sprint$_G$ il team registra una flessione dal punto di vista temporale, accumulando nuovamente ritardo rispetto al piano ideale. Di contro si rileva un eccellente recupero dell'efficenza economica.
...
\begin{itemize}
    ...
    \item \textbf{Valore accettabile SV:} $SV\geq 0$, vincolo$_G$ \textit{violato} in due sprint$_G$ su cinque con slittamenti consistenti.
\end{itemize}
\begin{figure}[H]
...
Dall'aggiudicazione del capitolato$_G$ fino alla revisione della RTB$_G$, l'\textit{Estimate At Completion} oscilla attorno al \textit{Budget At Completion}. L'EAC supera il BAC solo in due occasioni:
\begin{itemize}
    \item \textbf{Sprint 1:} come detto anche nelle altre sezioni, il promo sprint$_G$ ha sofferto dell'inesperienza del gruppo nell'organizzare le task$_G$, dimensionarle e portarle a compimento, Questo ha provocato un leggero sforamento di budget$_G$.
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimale:} EAC$\leq$ budget$_G$, vincolo$_G$ \textit{violato} in due sprint$_G$ su cinque.
\end{itemize}
...
\begin{table}[H]
	...
	\label{tab:mr}
\end{table}
Dal grafico in Figura §\ref{fig:mr} possiamo notare come la valutazione di \textit{Merge Rework}, ovvero la percentuale di Pull Request$_G$ approvate nelle quali viene sovrascritto del lavoro già svolto, varia a seconda della fase del progetto. Nei primi due sprint$_G$ troviamo dei valori simili ($7\%$ circa) che riteniamo accettabili. Questi valor sono dati dal fatto che tutti i membri del gruppo non avevano avuto ancora esperienza di co-working con lo strumento GitHub$_G$, né con un progetto con un gruppo così numeroso. Questo ha portato iniziali incomprensioni sul lavoro da svolgere che ha portato a riscritture di parti di documenti. Nel terzo e quarto sprint$_G$ abbiamo valori critici, dovuti principalmente all'\textit{Analisi dei Requisiti} (primo grande documento condiviso da più redattori) e dalla sua riscrittura, dovuta a revisioni a seguito di numerosi difetti di modellazione riscontrati.
Nello sprint$_G$ 5 abbiamo avuto un'enorme mole di Pull Request$_G$ dovute all'inizio del \textit{Proof of Concept} che però sono state minimamente sovrascritte grazie ad una progettazione adeguata. Valutazione:
\begin{itemize}
