...
\begin{longtable}{|c|c|c|c|c|p{4cm}|}
    ...
    \hline
    \endhead
    1.0.0 & 2026-06-24 & - & S. Vendramin & D. Facco & Approvazione finale \\
    \hline
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} EV$\geq PV$, vincolo \textit{violato} in uno sprint su cinque.
\end{itemize}
\begin{figure}[H]
...
Dall'aggiudicazione del capitolato fino alla revisione della RTB, l'\textit{Estimate At Completion} oscilla attorno al \textit{Budget At Completion}. L'EAC supera il BAC solo in due occasioni:
\begin{itemize}
