...
I test$_G$ di integrazione$_G$ verificano la corretta collaborazione tra più componenti del sistema$_G$. Essi sono particolarmente importanti per controllare:
\begin{itemize}
    \item la comunicazione tra editor e renderer Markdown;
    \item l'invio del testo selezionato alle funzioni LLM$_G$;
    \item la ricezione e visualizzazione della risposta del modello;
    \item il collegamento tra interfaccia utente e sistema$_G$ di persistenza;
    \item la gestione degli errori provenienti da API$_G$ esterne.
\end{itemize}

Questi test$_G$ permettono di individuare errori che non emergono necessariamente durante la verifica$_G$ delle singole unità, ma che si manifestano quando più componenti vengono usati insieme.
