...
\begin{longtable}{|c|c|c|c|c|p{4cm}|}
    ...
    \hline
    \endhead
    0.5.0 & 2026-06-24 & S. Zecchinato & - & - & Aggiunge valutazione MPC-PMS e sistema le altre \\
    \hline
...
Valutazione: 
\begin{itemize}
    \item \textbf{Valore accettabile CV:} $CV>0$, vincolo \textit{violato} in tre sprint su cinque con scostamenti consistenti.
