...
Valutazione: 
\begin{itemize}
    \item \textbf{Valore accettabile CV:} $CV>0$, vincolo \textit{violato} in uno sprint su tr con scostamento lieve.
...
\begin{itemize}
    \item \textbf{Valore accettabile:} EAC$\leq 110\%$ budget, vincolo \textit{rispettato}.
    \item \textbf{Valore ottimale:} EAC$\leq$ budget, vincolo \textit{violato} in uno sprint su tre.
\end{itemize}
\begin{figure}[H]
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $TCR = 100\%$, vincolo \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $TS = 0\%$, vincolo \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $MR \leq 5\%$, vincolo \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Valore ottimo:} $IR = 0\%$, vincolo \textit{rispettato}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Valore accettabile:} $PMS \geq 80\%$, vincolo \textit{non rispettato} nello sprint 3.
\end{itemize}

\subsubsection{PB}
Valutazione:
\begin{itemize}
    \item \textbf{Valore accettabile:} $PMS \geq 80\%$, vincolo \textit{rispettato}.
    \item \textbf{Valore ottimo:} $PMS = 100\%$, vincolo \textit{non rispettato} nello sprint 9.
\end{itemize}
