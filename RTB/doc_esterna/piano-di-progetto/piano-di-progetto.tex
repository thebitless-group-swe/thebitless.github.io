...
\newcommand{\dataversione}{2026-06-20}
...
\begin{center}
    \small
    \renewcommand{\arraystretch}{1.2} % Altezza righe contenuta cosi' titolo e tabella stanno sulla stessa pagina
...
Di seguito è riportato il preventivo economico del quinto sprint$G$:
...
\subsection{Sprint \#6: da 2026-06-16 a 2026-06-29}
Di seguito è riportata la distribuzione delle ore preventivate per ciascun membro del team:
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{3} & \textbf{9} & \textbf{-} & \textbf{6} & \textbf{23} & \textbf{13} & \textbf{54} \\
        \hline
    \end{tabular}
...
\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90.0:\r) arc[start angle=90.0,end angle=70.0,radius=\r] -- cycle;

\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (70.0:\r) arc[start angle=70.0,end angle=10.0,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (10.0:\r) arc[start angle=10.0,end angle=-30.0,radius=\r] -- cycle;

\path[fill=colPr, draw=white, line width=1.5pt]
(0,0) -- (-30.0:\r) arc[start angle=-30.0,end angle=-183.3,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-183.3:\r) arc[start angle=-183.3,end angle=-270.0,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (80:1.9) {5,6\%};
\node[font=\small\bfseries] at (40:1.75) {16,7\%};
\node[font=\small\bfseries] at (-10:1.95) {11,1\%};
\node[font=\small\bfseries] at (-107:1.55) {42,6\%};
\node[font=\small\bfseries] at (-227:1.85) {24,1\%};
...
\draw[lineGray, line width=0.7pt] (-0.8,-2.6) -- (-5.5,-2.6);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,-2.53) {Programmatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,-2.75) {23 ore};

% Verificatore
\fill[lineGray] (-1.3,2.4) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-1.3,2.4) -- (-5.5,2.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,2.47) {Verificatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,2.25) {13 ore};
...
Di seguito è riportato il preventivo economico del sesto sprint$G$:
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        Verificatore & 13 & 195,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{54} & \textbf{960,00} \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & - & - & 5 & - & - & - & 5 \\ \hline
        E. De Piccoli & - & 5 & - & - & - & - & 5 \\ \hline
        D. Facco & - & - & 7 & - & - & - & 7 \\ \hline
        A. Marini & - & - & 4 & - & - & - & 4 \\ \hline
        A. Menegaldo & - & - & - & - & - & 8 & 8 \\ \hline
        S. Vendramin & 6 & - & - & - & - & - & 6 \\ \hline
        S. Zecchinato & - & - & 5 & - & - & - & 5 \\ \hline
        \rowcolor{bluBitless!8}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \hline
        L. Battistella & 7 & 9 & 4 & 22 & 22 & 23 & 87 \\ \hline
        E. De Piccoli & 7 & 4 & 9 & 22 & 22 & 23 & 87 \\ \hline
        D. Facco & 7 & 8 & 2 & 22 & 23 & 23 & 85 \\ \hline
        A. Marini & 7 & 8 & 5 & 22 & 23 & 23 & 88 \\ \hline
        A. Menegaldo & 7 & 8 & 9 & 23 & 22 & 15 & 84 \\ \hline
        S. Vendramin & 1 & 9 & 8 & 22 & 24 & 22 & 86 \\ \hline
        S. Zecchinato & 6 & 9 & 4 & 23 & 22 & 23 & 87 \\ \hline
        \rowcolor{bluBitless!8}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 9 & 2 & 22 & 22 & 23 & 80 \\ \hline
        E. De Piccoli & 7 & 4 & 9 & 22 & 22 & 17 & 81 \\ \hline
        D. Facco & 7 & 8 & 2 & 22 & 23 & 16 & 78 \\ \hline
        A. Marini & 7 & 1 & 5 & 22 & 23 & 23 & 81 \\ \hline
        A. Menegaldo & 7 & 8 & 3 & 23 & 22 & 15 & 78 \\ \hline
        S. Vendramin & 1 & 9 & 1 & 22 & 24 & 22 & 79 \\ \hline
        S. Zecchinato & 6 & 9 & 1 & 23 & 22 & 20 & 81 \\ \hline
        \rowcolor{bluBitless!8}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 2 & 2 & 22 & 22 & 23 & 73 \\ \hline
        E. De Piccoli & 7 & 4 & 1 & 22 & 22 & 17 & 73 \\ \hline
        D. Facco & 7 & 8 & 2 & 15 & 23 & 16 & 71 \\ \hline
        A. Marini & 3 & 1 & 2 & 22 & 23 & 23 & 74 \\ \hline
        A. Menegaldo & 7 & 8 & 2 & 17 & 22 & 15 & 71 \\ \hline
        S. Vendramin & 1 & 9 & 0 & 22 & 24 & 16 & 72 \\ \hline
        S. Zecchinato & 6 & 9 & 1 & 23 & 22 & 13 & 74 \\ \hline
        \rowcolor{bluBitless!8}
...
\begin{itemize}
    ...
    \item Il gruppo ha riscontrato un feedback positivo nell'organizzazione e nella conduzione delle riunioni, adottando un approccio strutturato che ha garantito confronti produttivi, buone idee e una gestione ottimale del tempo;
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 2 & 2 & 13 & 22 & 23 & 64 \\ \hline
        E. De Piccoli & 7 & 4 & 1 & 13 & 22 & 17 & 64 \\ \hline
        D. Facco & 7 & 1 & 2 & 15 & 23 & 16 & 64 \\ \hline
        A. Marini & 3 & 1 & 2 & 22 & 23 & 15 & 66 \\ \hline
        A. Menegaldo & 7 & 5 & 0 & 17 & 22 & 15 & 66 \\ \hline
        S. Vendramin & 1 & 9 & 0 & 22 & 15 & 16 & 63 \\ \hline
        S. Zecchinato & 2 & 9 & 1 & 23 & 19 & 13 & 67 \\ \hline
        \rowcolor{bluBitless!8}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 2 & 2 & 13 & 22 & 14 & 55 \\ \hline
        E. De Piccoli & 7 & 4 & 1 & 13 & 11 & 17 & 53 \\ \hline
        D. Facco & 7 & 1 & 2 & 15 & 11 & 16 & 52 \\ \hline
        A. Marini & 3 & 1 & 2 & 22 & 11 & 15 & 54 \\ \hline
        A. Menegaldo & 5 & 5 & 0 & 17 & 16 & 15 & 58 \\ \hline
        S. Vendramin & 1 & 1 & 0 & 22 & 15 & 16 & 55 \\ \hline
        S. Zecchinato & 2 & 9 & 1 & 17 & 19 & 13 & 61 \\ \hline
        \rowcolor{bluBitless!8}
...
\subsubsection{Revisione delle attività}
Nel corso del quinto sprint\textsubscript{G}, il team ha portato avanti lo sviluppo del \textit{Proof of Concept} del prodotto \textit{Second Brain}, concentrando l'effort sulle attività di codifica e di verifica. In particolare sono state svolte le seguenti attività, coerentemente con la pianificazione:
\begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{RT-1 - Scarsa esperienza con le tecnologie utilizzate}
        \begin{itemize}
            \item \textbf{Descrizione:} Durante la codifica delle componenti del PoC sono emerse alcune difficoltà legate alla limitata familiarità con la gestione dello streaming delle risposte degli LLM\textsubscript{G} e con l'integrazione tra il back-end Python\textsubscript{G} e il front-end React\textsubscript{G}, che hanno richiesto un effort leggermente superiore al previsto sul ruolo di Programmatore.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        S. Zecchinato & - & 9 & - & - & - & - & 9 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{3} & \textbf{9} & \textbf{-} & \textbf{6} & \textbf{26} & \textbf{10} & \textbf{54} \\
        \hline
    \end{tabular}
...
\path[fill=colPr, draw=white, line width=1.5pt]
(0,0) -- (-30.0:\r) arc[start angle=-30.0,end angle=-203.3,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-203.3:\r) arc[start angle=-203.3,end angle=-270.0,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (80:1.9) {5,6\%};
\node[font=\small\bfseries] at (40:1.75) {16,7\%};
\node[font=\small\bfseries] at (-10:1.95) {11,1\%};
\node[font=\small\bfseries] at (-117:1.55) {48,1\%};
\node[font=\small\bfseries] at (-237:1.85) {18,5\%};
...
\draw[lineGray, line width=0.7pt] (-0.8,-2.6) -- (-5.5,-2.6);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,-2.53) {Programmatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,-2.75) {26 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Analista & 0 & 0 & 0,00 & 0,00 \\ \hline
        Progettista & 6 & 0 & 150,00 & 0,00 \\ \hline
        Programmatore & 26 & +3 & 390,00 & +45,00 \\ \hline
        Verificatore & 10 & -3 & 150,00 & -45,00 \\ \hline

        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{54} & \textbf{0} & \textbf{960,00} & \textbf{0,00} \\ \hline

        Sprint pregressi & 256 & / & 5.250,00 & / \\ \hline
        Restante & 334 & / & 6.650,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 2 & 2 & 13 & 14 & 14 & 47 \\ \hline
        E. De Piccoli & 4 & 4 & 1 & 13 & 11 & 13 & 46 \\ \hline
        D. Facco & 7 & 1 & 2 & 15 & 2 & 16 & 43 \\ \hline
        A. Marini & 3 & 1 & 2 & 16 & 11 & 15 & 48 \\ \hline
        A. Menegaldo & 5 & 5 & 0 & 17 & 7 & 15 & 49 \\ \hline
        S. Vendramin & 1 & 1 & 0 & 22 & 15 & 10 & 49 \\ \hline
        S. Zecchinato & 2 & 0 & 1 & 17 & 19 & 13 & 52 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{24} & \textbf{14} & \textbf{8} & \textbf{113} & \textbf{79} & \textbf{96} & \textbf{334} \\
        \hline
    \end{tabular}
...
\subsubsection{Revisione delle attività}
Nel corso del sesto sprint\textsubscript{G} il team ha portato a termine lo sviluppo del \textit{Proof of Concept} del prodotto \textit{Second Brain} e ha consolidato la documentazione a supporto della candidatura alla RTB\textsubscript{G}. In particolare sono state svolte le seguenti attività:
\begin{itemize}
    \item Completamento del PoC, con la finalizzazione delle funzionalità basate su LLM\textsubscript{G} e il consolidamento dell'integrazione tra front-end e back-end;
    \item Stesura del documento di guida alle tecnologie adottate, pensato come supporto alla presentazione del progetto al prof. Cardin;
    \item Avanzamento delle attività di verifica sui documenti di progetto e sulle funzioni del PoC, non concluse entro la fine dello sprint\textsubscript{G};
    \item Rifinitura e aggiornamento dei documenti di progetto (\textit{Piano di Progetto}, \textit{Norme di Progetto} e \textit{Analisi dei Requisiti}) in vista della consegna della RTB\textsubscript{G}.
\end{itemize}

\subsubsection{Retrospettiva}
A seguire le analisi a posteriori del sesto sprint\textsubscript{G}:
\begin{itemize}
    \item Il bilancio orario è risultato in linea con le previsioni: a fronte delle 54 ore preventivate ne sono state svolte altrettante (54), senza scostamenti complessivi;
    \item Sul ruolo di Programmatore si è registrato un lieve sforamento (26 ore contro le 23 preventivate, +3), del tutto fisiologico per le attività di completamento e rifinitura del PoC;
    \item Sul ruolo di Verificatore le ore consuntivate (10) sono risultate inferiori alle 13 preventivate. Lo scostamento \textbf{non} deriva da un minore carico di lavoro: le attività di verifica pianificate — la verifica di tutti i documenti previsti e delle funzioni del PoC, così come definite nelle relative issue\textsubscript{G} — non sono state portate a termine entro la chiusura dello sprint\textsubscript{G}. Il team prevede di completarle nei giorni immediatamente successivi;
    \item Tra gli obiettivi dello sprint\textsubscript{G} rientrava l'invio al prof. Cardin della richiesta di candidatura alla RTB\textsubscript{G}, con la relativa presentazione: tale attività non è stata effettuata entro la fine dello sprint\textsubscript{G}. La volontà espressa in fase di preventivo non si è quindi concretizzata nei tempi previsti ed è rimandata ai giorni successivi, contestualmente al completamento delle attività di verifica;
    \item Per i restanti ruoli il consuntivo ha rispettato il preventivo, a conferma della buona tenuta complessiva della pianificazione;
    \item Il clima di lavoro è rimasto sereno e collaborativo e la comunicazione interna è risultata fluida sia nelle riunioni dedicate sia nello scambio quotidiano tra i membri del gruppo.
\end{itemize}

\subsubsection{Aggiornamento della pianificazione e del preventivo}
Il team ha individuato le seguenti priorità per il breve periodo:
\begin{itemize}
    \item Completare la verifica dei documenti ancora aperti e delle funzioni del PoC;
    \item Inviare al prof. Cardin la richiesta di candidatura alla RTB\textsubscript{G} con la relativa presentazione;
    \item Effettuare le ultime rifiniture formali sui documenti di progetto in vista della consegna.
\end{itemize}

\paragraph{Pianificazione futura}
Nei giorni immediatamente successivi alla chiusura dello sprint\textsubscript{G} il gruppo concentrerà l'effort sul completamento delle attività di verifica residue, relative sia ai documenti di progetto sia alle funzioni del PoC, e sull'invio al prof. Cardin della richiesta di candidatura alla RTB\textsubscript{G} con la relativa presentazione. Si tratta di attività pianificate per questo sprint\textsubscript{G} ma non concluse entro la sua scadenza, il cui completamento è previsto a brevissimo termine senza impatti sul calendario complessivo del progetto.

\paragraph{Preventivo a finire (\hyperref[tab:preventivo-finire]{Sezione \S6})}
Lo scostamento orario complessivo è risultato nullo e non richiede una revisione sostanziale del preventivo a finire. Le ore non impiegate sul ruolo di Verificatore entro lo sprint\textsubscript{G} non rappresentano un risparmio, bensì attività posticipate: verranno recuperate nei giorni successivi attingendo al monte ore residuo del ruolo, ancora ampiamente capiente (96 ore rimanenti). La flessibilità di allocazione delle risorse resta confermata per assorbire eventuali necessità nelle fasi conclusive della RTB\textsubscript{G}.

\paragraph{Gestione dei rischi (\hyperref[tab:gestione-rischi]{Sezione \S2})}
Nel corso del sesto sprint\textsubscript{G} non si sono manifestati rischi di particolare gravità.
\begin{itemize}
    \item \textbf{Rischi occorsi e mitigati:}
    \begin{itemize}
        \item \textbf{RO-8 - Errata stima delle attività}
        \begin{itemize}
            \item \textbf{Descrizione:} Le attività di verifica dei documenti e delle funzioni del PoC pianificate per lo sprint\textsubscript{G} hanno richiesto un tempo superiore a quello stimato e non sono state completate entro la sua chiusura, posticipando di conseguenza anche l'invio della richiesta di candidatura alla RTB\textsubscript{G} al prof. Cardin.
            \item \textbf{Esito della mitigazione:} Positivo. Il team ha circoscritto con precisione le attività residue e ne ha programmato il completamento nei giorni immediatamente successivi, attingendo al monte ore ancora disponibile sul ruolo di Verificatore.
            \item \textbf{Impatto:} Contenuto. Si tratta di attività posticipate di pochi giorni e non di lavoro perso; lo scostamento non incide sul calendario complessivo né sulla data di consegna stimata, ma conferma la necessità di dimensionare con maggiore prudenza i tempi delle attività di verifica nelle fasi a ridosso delle milestone\textsubscript{G}.
        \end{itemize}
    \end{itemize}
\end{itemize}
