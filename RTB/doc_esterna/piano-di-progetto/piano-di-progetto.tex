...
\subsubsection{Obiettivi}
Gli obiettivi dello Sprint \#5 sono stati definiti a partire dalle evidenze emerse nella retrospettiva precedente e in coerenza con l'avanzamento complessivo del progetto.

\begin{itemize}
    \item  Avanzamento del PoC, con implementazione del frontend e del backend. L'obiettivo è chiudere lo sviluppo del PoC entro la finestra dello sprint.

    \item Proseguimento della stesura del \textit{Piano di Qualifica}, con particolare attenzione alla sezione dedicata alle metriche di prodotto, che saranno popolate a partire dai test effettivamente eseguiti sul PoC. La disponibilità di codice funzionante consentirà di passare da definizioni astratte a misurazioni concrete.

    \item Aggiornamento del \textit{Piano di Progetto} per riflettere i consuntivi dello Sprint \#4 e la pianificazione rivista per gli sprint successivi.

    \item Revisione e consolidamento delle\textit{Norme di Progetto}, con correzione di eventuali refusi, aggiornamento dei riferimenti incrociati e allineamento allo stato corrente del progetto.

    \item Avanzamento del \textit{Glossario} con i nuovi termini emersi durante lo sviluppo e la progettazione.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        D. Facco & - & - & - & - & 9 & - & 9 \\ \hline
        A. Marini & - & - & - & - & 9 & - & 9 \\ \hline
        A. Menegaldo & 5 & - & - & - & - & 3 & 8 \\ \hline
        S. Vendramin & - & 7 & - & - & - & - & 7 \\ \hline
        S. Zecchinato & - & - & - & 8 & - & - & 8 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{5} & \textbf{7} & \textbf{-} & \textbf{8} & \textbf{27} & \textbf{11} & \textbf{58} \\
        \hline
    \end{tabular}
...
% Am: 7 ore   -> 12,1%  -> 43.4°
% Pt: 8 ore   -> 13,8%  -> 49.7°
% Pr: 27 ore  -> 46,6%  -> 167.6°
% Ve: 11 ore  -> 19,0%  -> 68.3°

\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90:\r) arc[start angle=90,end angle=59.0,radius=\r] -- cycle;

\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (59.0:\r) arc[start angle=59.0,end angle=15.6,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (15.6:\r) arc[start angle=15.6,end angle=-34.1,radius=\r] -- cycle;

\path[fill=colPr, draw=white, line width=1.5pt]
(0,0) -- (-34.1:\r) arc[start angle=-34.1,end angle=-201.7,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-201.7:\r) arc[start angle=-201.7,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (74:1.75) {8,6\%};
\node[font=\small\bfseries] at (37:1.75) {12,1\%};
\node[font=\small\bfseries] at (-9:1.85) {13,8\%};
\node[font=\small\bfseries] at (-118:1.55) {46,6\%};
\node[font=\small\bfseries] at (124:1.85) {19,0\%};

% Etichette esterne
% Responsabile
\fill[lineGray] (1.3,2.8) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (1.3,2.8) -- (3.5,2.8) -- (5.5,2.8);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,2.87) {Responsabile};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,2.65) {5 ore};
...
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,1.05) {7 ore};

% Progettista
\fill[lineGray] (3.0,-0.8) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (3.0,-0.8) -- (4.2,-0.8) -- (5.5,-0.8);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,-0.73) {Progettista};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,-0.95) {8 ore};

% Programmatore
\fill[lineGray] (-0.8,-3.1) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-0.8,-3.1) -- (-2.0,-3.1) -- (-5.5,-3.1);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,-3.03) {Programmatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,-3.25) {27 ore};

% Verificatore
\fill[lineGray] (-2.2,2.4) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (-2.2,2.4) -- (-3.8,2.4) -- (-5.5,2.4);
\node[anchor=south west, font=\normalsize\bfseries] at (-5.5,2.47) {Verificatore};
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.5,2.25) {11 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        Programmatore & 27 & 405,00 \\ \hline
        Verificatore & 11 & 165,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{58} & \textbf{1.060,00} \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        S. Zecchinato & - & - & 6 & - & - & - & 6 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{6} & \textbf{5} & \textbf{28} & \textbf{-} & \textbf{-} & \textbf{8} & \textbf{47} \\
        \hline
    \end{tabular}
...
% Settori
\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90:\r) arc[start angle=90,end angle=44.0,radius=\r] -- cycle;

\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (44.0:\r) arc[start angle=44.0,end angle=5.7,radius=\r] -- cycle;

\path[fill=colAn, draw=white, line width=1.5pt]
(0,0) -- (5.7:\r) arc[start angle=5.7,end angle=-208.7,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-208.7:\r) arc[start angle=-208.7,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\normalsize\bfseries] at (61:1.75) {12,8\%};
\node[font=\normalsize\bfseries] at (8:1.45) {10,6\%};
\node[font=\normalsize\bfseries] at (-106:1.55) {59,6\%};
\node[font=\normalsize\bfseries] at (123:1.85) {17,0\%};
...
\node[anchor=north west, font=\small\bfseries, text=lineGray] at (-5.45,-3.00) {28 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \hline
        L. Battistella & 7 & 9 & 2 & 22 & 22 & 23 & 85 \\ \hline
        E. De Piccoli & 7 & 4 & 9 & 22 & 22 & 23 & 87 \\ \hline
        D. Facco & 7 & 8 & 0 & 22 & 23 & 23 & 83 \\ \hline
        ...
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{42} & \textbf{55} & \textbf{34} & \textbf{156} & \textbf{158} & \textbf{152} & \textbf{597} \\
        \hline
    \end{tabular}
...
\begin{itemize}
    ...
    le ore consuntivate per il ruolo di Analista sono risultate superiori
    rispetto a quelle preventivate (28 ore effettive contro le 24 previste,
    +4 ore). Il gruppo ha avuto bisogno di ore aggiuntive di ``palestra''
    iniziale per familiarizzare con il contesto del progetto: comprendere
    l'analisi del capitolato, studiare cosa fossero i casi d'uso\textsubscript{G}
    e i requisiti\textsubscript{G}, e assimilare le modalità corrette di
    documentazione. Questo investimento di apprendimento, pur non producendo
    direttamente documentazione, è stato necessario per costruire le competenze
    di base indispensabili alle attività di analisi degli sprint successivi.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            rivelata insufficiente. Sono state preventivate 24 ore, ma ne sono state
            consuntivate 28: il gruppo ha sottostimato il tempo necessario alla fase
            di studio e comprensione del contesto (casi d'uso\textsubscript{G},
            ...
            evidenziato la necessità di considerare esplicitamente, nelle stime
            successive, le ore di apprendimento e non solo quelle di produzione.
            \item \textbf{Impatto:} Contenuto. Le 4 ore aggiuntive rientrano nel
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Sprint pregressi & 47 & / & 1.100,00 & / \\ \hline
        Restante & 551 & / & 10.780,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \textbf{Membro del team} & \textbf{Re} & \textbf{Am} & \textbf{An} & \textbf{Pt} & \textbf{Pr} & \textbf{Ve} & \textbf{Totale per persona} \\
        \hline
        L. Battistella & 2 & 9 & 0 & 22 & 22 & 23 & 78 \\ \hline
        E. De Piccoli & 7 & 4 & 9 & 22 & 22 & 17 & 81 \\ \hline
        D. Facco & 7 & 8 & 0 & 22 & 23 & 16 & 76 \\ \hline
        ...
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{37} & \textbf{48} & \textbf{16} & \textbf{156} & \textbf{158} & \textbf{136} & \textbf{551} \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Sprint pregressi & 93 & / & 2.080,00 & / \\ \hline
        Restante & 501 & / & 9.675,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        D. Facco & 7 & 8 & 0 & 15 & 23 & 16 & 69 \\ \hline
        A. Marini & 3 & 1 & 0 & 22 & 23 & 23 & 72 \\ \hline
        A. Menegaldo & 7 & 8 & 2 & 17 & 22 & 15 & 71 \\ \hline
        S. Vendramin & 1 & 9 & 0 & 22 & 24 & 16 & 72 \\ \hline
        S. Zecchinato & 6 & 9 & 0 & 23 & 22 & 13 & 73 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{33} & \textbf{41} & \textbf{3} & \textbf{143} & \textbf{158} & \textbf{123} & \textbf{501} \\
        \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|}
        ...
        Sprint pregressi & 143 & / & 3.185,00 & / \\ \hline
        Restante & 447 & / & 8.555,00 & / \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        D. Facco & 7 & 1 & 0 & 15 & 23 & 16 & 62 \\ \hline
        A. Marini & 3 & 1 & 0 & 22 & 23 & 15 & 64 \\ \hline
        A. Menegaldo & 7 & 5 & 0 & 17 & 22 & 15 & 66 \\ \hline
        S. Vendramin & 1 & 9 & 0 & 22 & 15 & 16 & 63 \\ \hline
        S. Zecchinato & 2 & 9 & 0 & 23 & 19 & 13 & 66 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{29} & \textbf{31} & \textbf{1} & \textbf{125} & \textbf{146} & \textbf{115} & \textbf{447} \\
        \hline
    \end{tabular}
