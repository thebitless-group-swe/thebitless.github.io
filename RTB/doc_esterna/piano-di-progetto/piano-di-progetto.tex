...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
        ...
        \rowcolor{bluBitless!8}
        \textbf{Totale per ruolo} & \textbf{3} & \textbf{7} & \textbf{-} & \textbf{12} & \textbf{24} & \textbf{15} & \textbf{61} \\
        \hline
    \end{tabular}
...
% Settori (Totale = 61 ore)
% Re: 3 ore   -> 4,9%   -> 17.7°
% Am: 7 ore   -> 11,5%  -> 41.3°
% Pt: 12 ore  -> 19,7%  -> 70.8°
% Pr: 24 ore  -> 39,3%  -> 141.6°
% Ve: 15 ore  -> 24,6%  -> 88.5°

\path[fill=colResp, draw=white, line width=1.5pt]
(0,0) -- (90:\r) arc[start angle=90,end angle=72.3,radius=\r] -- cycle;

\path[fill=colAmm, draw=white, line width=1.5pt]
(0,0) -- (72.3:\r) arc[start angle=72.3,end angle=31.0,radius=\r] -- cycle;

\path[fill=colPt, draw=white, line width=1.5pt]
(0,0) -- (31.0:\r) arc[start angle=31.0,end angle=-39.8,radius=\r] -- cycle;

\path[fill=colPr, draw=white, line width=1.5pt]
(0,0) -- (-39.8:\r) arc[start angle=-39.8,end angle=-181.5,radius=\r] -- cycle;

\path[fill=colVe, draw=white, line width=1.5pt]
(0,0) -- (-181.5:\r) arc[start angle=-181.5,end angle=-270,radius=\r] -- cycle;

% Percentuali interne
\node[font=\small\bfseries] at (81:1.95) {4,9\%};
\node[font=\small\bfseries] at (52:1.75) {11,5\%};
\node[font=\small\bfseries] at (-4:1.85) {19,7\%};
\node[font=\small\bfseries] at (-111:1.55) {39,3\%};
\node[font=\small\bfseries] at (134:1.85) {24,6\%};
...
\draw[lineGray, line width=0.7pt] (1.3,1.6) -- (5.5,1.6);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,1.67) {Amministratore};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,1.45) {7 ore};

% Progettista
\fill[lineGray] (2.6,0.3) circle (1.7pt);
\draw[lineGray, line width=0.7pt] (2.6,0.3) -- (5.5,0.3);
\node[anchor=south east, font=\normalsize\bfseries] at (5.5,0.37) {Progettista};
\node[anchor=north east, font=\small\bfseries, text=lineGray] at (5.5,0.15) {12 ore};
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        Amministratore & 7 & 140,00 \\ \hline
        Analista & 0 & 0,00 \\ \hline
        Progettista & 12 & 300,00 \\ \hline
        Programmatore & 24 & 360,00 \\ \hline
        Verificatore & 15 & 225,00 \\ \hline
        \rowcolor{bluBitless!8}
        \textbf{Totale} & \textbf{61} & \textbf{1.115,00} \\ \hline
    \end{tabular}
