...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|c|c|c|c|c|c|c|}
        ...
        \hline
        \rowcolor[HTML]{EFEFEF}
        \textbf{Costo totale (in €)} & \textbf{630,00} & \textbf{240,00} & \textbf{200,00} & \textbf{2.225,00} & \textbf{1.260,00} & \textbf{1.305,00} & \textbf{5.860,00} \\
        \hline
    \end{tabularx}
